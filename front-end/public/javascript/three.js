...
THREE.Color.prototype = {
    ...
    setHSV: function (a, b, c) {
        var d, e, f;
        0 === c ? this.r = this.g = this.b = 0 : (d = Math.floor(6 * a), e = 6 * a - d, a = c * (1 - b), f = c * (1 - b * e), b = c * (1 - b * (1 - e)), 0 === d ? (this.r = c, this.g = b, this.b = a) : 1 === d ? (this.r = f, this.g = c, this.b = a) : 2 === d ? (this.r = a, this.g = c, this.b = b) : 3 === d ? (this.r = a, this.g = f, this.b = c) : 4 === d ? (this.r = b, this.g = a, this.b =
            c) : 5 === d && (this.r = c, this.g = a, this.b = f));
        return this
    },
    getHex: function () {
    ...
    setStyle: function (a) {
        ...
        if (/^\#([0-9a-f])([0-9a-f])([0-9a-f])$/i.test(a)) return a =
            /^\#([0-9a-f])([0-9a-f])([0-9a-f])$/i.exec(a), this.setHex(parseInt(a[1] + a[1] + a[2] + a[2] + a[3] + a[3], 16)), this;
...
THREE.Vector4.prototype = {
    ...
    setAxisAngleFromRotationMatrix: function (a) {
        ...
        if (0.01 > Math.abs(d - g) && 0.01 > Math.abs(f - c) && 0.01 > Math.abs(i - b)) {
            if (0.1 >
                Math.abs(d + g) && 0.1 > Math.abs(f + c) && 0.1 > Math.abs(i + b) && 0.1 > Math.abs(e + h + k - 3)) return this.set(1, 0, 0, 0), this;
            a = Math.PI;
            e = (e + 1) / 2;
            h = (h + 1) / 2;
            k = (k + 1) / 2;
...
THREE.Box3.prototype = {
    ...
    size: function (a) {
        return (a || new THREE.Vector3).sub(this.max,
            this.min)
    },
    expandByPoint: function (a) {
        this.min.minSelf(a);
    ...
    containsBox: function (a) {
        return this.min.x <= a.min.x && a.max.x <= this.max.x && this.min.y <= a.min.y && a.max.y <= this.max.y &&
            this.min.z <= a.min.z && a.max.z <= this.max.z ? !0 : !1
    },
    getParameter: function (a) {
    ...
    distanceToPoint: function (a) {
        return THREE.Box3.__v1.copy(a).clampSelf(this.min,
            this.max).subSelf(a).length()
    },
    ...
    transform: function (a) {
        a = [a.multiplyVector3(THREE.Box3.__v0.set(this.min.x, this.min.y, this.min.z)), a.multiplyVector3(THREE.Box3.__v1.set(this.min.x, this.min.y, this.max.z)), a.multiplyVector3(THREE.Box3.__v2.set(this.min.x,
            this.max.y, this.min.z)), a.multiplyVector3(THREE.Box3.__v3.set(this.min.x, this.max.y, this.max.z)), a.multiplyVector3(THREE.Box3.__v4.set(this.max.x, this.min.y, this.min.z)), a.multiplyVector3(THREE.Box3.__v5.set(this.max.x, this.min.y, this.max.z)), a.multiplyVector3(THREE.Box3.__v6.set(this.max.x, this.max.y, this.min.z)), a.multiplyVector3(THREE.Box3.__v7.set(this.max.x, this.max.y, this.max.z))];
        this.makeEmpty();
...
THREE.Matrix4 = function (a, b, c, d, e, f, g, h, i, k, n, p, m, r, s, l) {
    ...
    this.set(void 0 !== a ? a : 1, b || 0, c || 0, d || 0, e || 0, void 0 !== f ? f : 1, g || 0, h || 0, i || 0, k || 0, void 0 !== n ? n : 1, p || 0, m || 0, r || 0, s || 0, void 0 !== l ? l : 1)
};
THREE.Matrix4.prototype = {
    ...
    setRotationFromEuler: function (a, b) {
        ...
        if (void 0 === b || "XYZ" === b) {
            ...
            c[6] = p + n * e;
            c[10] = g * h
        } else "YXZ" === b ? (k = h * i, n = h * f, p = e * i, m = e * f, c[0] = k + m * d, c[4] = p * d - n, c[8] = g * e, c[1] = g * f, c[5] = g * i, c[9] = -d, c[2] = n * d - p, c[6] = m + k * d, c[10] = g * h) : "ZXY" === b ? (k = h * i, n = h * f, p = e * i, m = e * f, c[0] = k - m * d, c[4] = -g * f, c[8] = p + n * d, c[1] = n + p * d, c[5] = g * i, c[9] = m - k * d, c[2] = -g * e, c[6] =
            d, c[10] = g * h) : "ZYX" === b ? (k = g * i, n = g * f, p = d * i, m = d * f, c[0] = h * i, c[4] = p * e - n, c[8] = k * e + m, c[1] = h * f, c[5] = m * e + k, c[9] = n * e - p, c[2] = -e, c[6] = d * h, c[10] = g * h) : "YZX" === b ? (k = g * h, n = g * e, p = d * h, m = d * e, c[0] = h * i, c[4] = m - k * f, c[8] = p * f + n, c[1] = f, c[5] = g * i, c[9] = -d * i, c[2] = -e * i, c[6] = n * f + p, c[10] = k - m * f) : "XZY" === b && (k = g * h, n = g * e, p = d * h, m = d * e, c[0] = h * i, c[4] = -f, c[8] = e * i, c[1] = k * f + m, c[5] = g * i, c[9] = n * f - p, c[2] = p * f - n, c[6] = d * i, c[10] = m * f + k);
        return this
    },
    ...
    multiplyVector3Array: function (a) {
        for (var b = THREE.Matrix4.__v1, c = 0, d = a.length; c < d; c += 3) b.x = a[c], b.y = a[c + 1], b.z = a[c + 2], this.multiplyVector3(b), a[c] = b.x, a[c + 1] = b.y, a[c + 2] = b.z;
        return a
    },
    ...
    determinant: function () {
        var a = this.elements,
            ...
            l = a[11],
            a = a[15];
        return e * h * n * r - d * i * n * r - e * g * p * r + c * i * p * r + d * g * m * r - c * h * m * r - e * h * k * s + d * i * k * s + e * f * p * s - b * i * p * s - d * f * m * s + b * h * m * s + e * g * k * l - c * i * k * l - e * f * n * l + b * i * n * l + c * f * m * l - b * g * m * l - d * g * k * a + c * h * k * a +
            d * f * n * a - b * h * n * a - c * f * p * a + b * g * p * a
    },
    transpose: function () {
        var a = this.elements,
            b;
    ...
    getInverse: function (a) {
        var b = this.elements,
            ...
            u = c[11],
            c = c[15];
        b[0] = k * s * q - n * r * q + n * m * u - i * s * u - k * m * c + i * r * c;
        b[4] = g * r * q - f * s * q - g * m * u + e * s * u + f * m * c - e * r * c;
        b[8] = f * n * q - g * k * q + g * i * u - e * n * u - f * i * c + e * k * c;
        b[12] = g * k * m - f * n * m - g * i * r + e *
            n * r + f * i * s - e * k * s;
        b[1] = n * r * l - k * s * l - n * p * u + h * s * u + k * p * c - h * r * c;
        b[5] = f * s * l - g * r * l + g * p * u - d * s * u - f * p * c + d * r * c;
        b[9] = g * k * l - f * n * l - g * h * u + d * n * u + f * h * c - d * k * c;
        b[13] = f * n * p - g * k * p + g * h * r - d * n * r - f * h * s + d * k * s;
        b[2] = i * s * l - n * m * l + n * p * q - h * s * q - i * p * c + h * m * c;
        b[6] = g * m * l - e * s * l - g * p * q + d * s * q + e * p * c - d * m * c;
        b[10] = e * n * l - g * i * l + g * h * q - d * n * q - e * h * c + d * i * c;
        b[14] = g * i * p - e * n * p - g * h * m + d * n * m + e * h * s - d * i * s;
        b[3] = k * m * l - i * r * l - k * p * q + h * r * q + i * p * u - h * m * u;
        b[7] = e * r * l - f * m * l + f * p * q - d * r * q - e * p * u + d * m * u;
        b[11] = f * i * l - e * k * l - f * h * q + d * k * q + e * h * u - d * i * u;
        b[15] = e * k * p - f * i * p + f * h * m - d * k * m -
            e * h * r + d * i * r;
    ...
    decompose: function (a, b, c) {
        ...
        b = b instanceof
        THREE.Quaternion ? b : new THREE.Quaternion;
    ...
    makeRotationX: function (a) {
        var b = Math.cos(a),
            a = Math.sin(a);
        this.set(1, 0, 0, 0, 0, b, -a, 0, 0, a, b,
            0, 0, 0, 0, 1);
        return this
    },
    ...
    makeScale: function (a) {
        this.set(a.x, 0, 0, 0, 0, a.y,
            0, 0, 0, 0, a.z, 0, 0, 0, 0, 1);
        return this
    },
...
THREE.Triangle.prototype = {
    ...
    midpoint: function (a) {
        return (a ||
            new THREE.Vector3).add(this.a, this.b).addSelf(this.c).multiplyScalar(1 / 3)
    },
    normal: function (a) {
...
(function (a) {
    ...
    var h = function (g, h, i) {
            if (g instanceof a.Particle) {
                ...
                for (var F = 0, C = m.faces.length; F < C; F++) {
                    var A = m.faces[F],
                        q = !0 ===
                        s ? l[A.materialIndex] : g.material;
                    if (void 0 !== q) {
                        d.setFromNormalAndCoplanarPoint(A.normal, r[A.a]);
                        var z = c.distanceToPlane(d);
                        if (!(Math.abs(z) < t) && !(0 > z)) {
                            q = q.side;
                            if (q !== a.DoubleSide && (u = c.direction.dot(d.normal), !(q === a.FrontSide ? 0 > u : 0 < u))) continue;
                            if (!(z < h.near || z > h.far)) {
                                e = c.at(z, e);
                                if (A instanceof a.Face3) {
                                    if (q = r[A.a], u = r[A.b], B = r[A.c], !a.Triangle.containsPoint(e, q, u, B)) continue
                                } else if (A instanceof a.Face4) {
                                    if (q = r[A.a], u = r[A.b], B = r[A.c], x = r[A.d], !a.Triangle.containsPoint(e, q, u, x) && !a.Triangle.containsPoint(e,
                                            u, B, x)) continue
    ...
    a.Raycaster.prototype.intersectObjects =
        function (a, b) {
            for (var c = [], d = 0, e = a.length; d < e; d++) h(a[d], this, c), !0 === b && i(a[d], this, c);
            c.sort(g);
            return c
        }
})(THREE);
...
THREE.Projector = function () {
    ...
    this.projectScene = function (g, h, p, pa) {
        var ya = h.near,
            ua = h.far,
            N = !1,
            O, aa, fa, V, ja, Z, ga, oa, za, Da, Ta, sa, nb, Bb, kb;
        z = t = q = r = 0;
        I.elements.length = 0;
        g.updateMatrixWorld();
            ...
            for (var c = 0, d = b.children.length; c < d; c++) {
                ...
                if (!1 !== f.visible) {
                    if (f instanceof THREE.Light) I.lights.push(f);
                        ...
                        if (!1 === f.frustumCulled || !0 === K.contains(f)) e = a(), e.object = f, null !== f.renderDepth ?
                            e.z = f.renderDepth : ($.copy(f.matrixWorld.getPosition()), L.multiplyVector3($), e.z = $.z), I.objects.push(e)
                    } else f instanceof THREE.Sprite || f instanceof THREE.Particle ? (e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : ($.copy(f.matrixWorld.getPosition()), L.multiplyVector3($), e.z = $.z), I.sprites.push(e)) : (e = a(), e.object = f, null !== f.renderDepth ? e.z = f.renderDepth : ($.copy(f.matrixWorld.getPosition()), L.multiplyVector3($), e.z = $.z), I.objects.push(e));
                    eb(f)
                }
            }
        };
        ...
        g = 0;
        for (p = I.objects.length; g <
            p; g++)
            if (oa = I.objects[g].object, za = oa.matrixWorld, k = 0, oa instanceof THREE.Mesh) {
                Da = oa.geometry;
                fa = Da.vertices;
                Ta = Da.faces;
                Da = Da.faceVertexUvs;
                ...
                O = 0;
                for (aa = fa.length; O < aa; O++) i = b(), i.positionWorld.copy(fa[O]), za.multiplyVector3(i.positionWorld), i.positionScreen.copy(i.positionWorld), L.multiplyVector4(i.positionScreen), i.positionScreen.x /= i.positionScreen.w, i.positionScreen.y /= i.positionScreen.w,
                    i.visible = i.positionScreen.z > ya && i.positionScreen.z < ua;
                fa = 0;
                for (O = Ta.length; fa < O; fa++)
                    if (aa = Ta[fa], kb = !0 === nb ? Bb.materials[aa.materialIndex] : oa.material, void 0 !== kb) {
                        Z = kb.side;
                        if (aa instanceof THREE.Face3)
                            if (V = n[aa.a], ja = n[aa.b], ga = n[aa.c], !0 === V.visible && !0 === ja.visible && !0 === ga.visible)
                                if (N = 0 > (ga.positionScreen.x - V.positionScreen.x) * (ja.positionScreen.y - V.positionScreen.y) - (ga.positionScreen.y - V.positionScreen.y) * (ja.positionScreen.x - V.positionScreen.x), Z === THREE.DoubleSide || N === (Z === THREE.FrontSide)) r ===
                                    l ? (sa = new THREE.RenderableFace3, s.push(sa), l++, r++, m = sa) : m = s[r++], m.v1.copy(V), m.v2.copy(ja), m.v3.copy(ga);
                                else continue;
                        else continue;
                        else if (aa instanceof THREE.Face4)
                            if (V = n[aa.a], ja = n[aa.b], ga = n[aa.c], sa = n[aa.d], !0 === V.visible && !0 === ja.visible && !0 === ga.visible && !0 === sa.visible)
                                if (N = 0 > (sa.positionScreen.x - V.positionScreen.x) * (ja.positionScreen.y - V.positionScreen.y) - (sa.positionScreen.y - V.positionScreen.y) * (ja.positionScreen.x - V.positionScreen.x) || 0 > (ja.positionScreen.x - ga.positionScreen.x) * (sa.positionScreen.y -
                                        ga.positionScreen.y) - (ja.positionScreen.y - ga.positionScreen.y) * (sa.positionScreen.x - ga.positionScreen.x), Z === THREE.DoubleSide || N === (Z === THREE.FrontSide)) {
                                    if (q === B) {
                        ...
                        !1 === N && (Z === THREE.BackSide || Z === THREE.DoubleSide) && m.normalWorld.negate();
                        ...
                        ga = aa.vertexNormals;
                        V = 0;
                        for (ja = ga.length; V < ja; V++) sa = m.vertexNormalsWorld[V], sa.copy(ga[V]), !1 === N && (Z === THREE.BackSide || Z === THREE.DoubleSide) && sa.negate(), J.multiplyVector3(sa).normalize();
...
THREE.Geometry.prototype = {
    ...
    computeVertexNormals: function (a) {
        ...
        if (a) {
            var f, g, h, i = new THREE.Vector3,
                ...
                m = new THREE.Vector3;
            b = 0;
            for (c = this.faces.length; b < c; b++) d = this.faces[b], d instanceof THREE.Face3 ? (a = this.vertices[d.a], f = this.vertices[d.b], g = this.vertices[d.c], i.sub(g, f), k.sub(a, f), i.crossSelf(k),
    ...
    computeTangents: function () {
        ...
        var b, c, d, e, f, g, h, i, k, n, p, m, r, s, l, q, u, B,
            x, t, F, C, A, z, H = [],
            G = [],
            I = new THREE.Vector3,
            $ = new THREE.Vector3,
            ...
            y = new THREE.Vector3;
        b = 0;
        for (c = this.vertices.length; b < c; b++) H[b] = new THREE.Vector3, G[b] = new THREE.Vector3;
        b = 0;
        ...
        for (c = this.faces.length; b < c; b++) {
            f = this.faces[b];
            for (d = 0; d <
                f.vertexNormals.length; d++) y.copy(f.vertexNormals[d]), e = f[J[d]], z = H[e], D.copy(z), D.subSelf(y.multiplyScalar(y.dot(z))).normalize(), L.cross(f.vertexNormals[d], z), e = L.dot(G[e]), e = 0 > e ? -1 : 1, f.vertexTangents[d] = new THREE.Vector4(D.x, D.y, D.z, e)
        }
        this.hasTangents = !0
    },
    ...
    mergeVertices: function () {
        ...
        for (g = this.faces.length; f < g; f++)
            if (a =
                this.faces[f], a instanceof THREE.Face3) a.a = c[a.a], a.b = c[a.b], a.c = c[a.c];
...
THREE.BufferGeometry.prototype = {
    ...
    computeVertexNormals: function () {
        if (this.attributes.position) {
            ...
            var e = this.attributes.position.array,
                ...
                g, h, i, k, n, p, m = new THREE.Vector3,
                r = new THREE.Vector3,
                s = new THREE.Vector3,
                l = new THREE.Vector3,
                q = new THREE.Vector3;
            if (this.attributes.index) {
                ...
                for (d = B.length; c < d; ++c) {
                    ...
                    var x = B[c].index;
                    a = b;
                    for (b += g; a < b; a += 3) g = x + u[a], h = x + u[a + 1], i = x + u[a + 2], k = e[3 * g], n = e[3 * g + 1], p = e[3 * g + 2], m.set(k, n, p), k = e[3 * h], n = e[3 * h + 1], p = e[3 * h + 2], r.set(k, n, p), k = e[3 * i], n = e[3 * i + 1], p = e[3 * i + 2], s.set(k,
                        n, p), l.sub(s, r), q.sub(m, r), l.crossSelf(q), f[3 * g] += l.x, f[3 * g + 1] += l.y, f[3 * g + 2] += l.z, f[3 * h] += l.x, f[3 * h + 1] += l.y, f[3 * h + 2] += l.z, f[3 * i] += l.x, f[3 * i + 1] += l.y, f[3 * i + 2] += l.z
                }
            } else {
                a = 0;
                for (b = e.length; a < b; a += 9) k = e[a], n = e[a + 1], p = e[a + 2], m.set(k, n, p), k = e[a + 3], n = e[a + 4], p = e[a + 5], r.set(k, n, p), k = e[a + 6], n = e[a + 7], p = e[a + 8], s.set(k, n, p), l.sub(s, r), q.sub(m, r), l.crossSelf(q), f[a] = l.x, f[a + 1] = l.y, f[a + 2] = l.z, f[a + 3] = l.x, f[a + 4] = l.y, f[a + 5] = l.z, f[a + 6] = l.x, f[a + 7] = l.y, f[a + 8] = l.z
            }
    ...
    normalizeNormals: function () {
        for (var a =
                this.attributes.normal.array, b, c, d, e = 0, f = a.length; e < f; e += 3) b = a[e], c = a[e + 1], d = a[e + 2], b = 1 / Math.sqrt(b * b + c * c + d * d), a[e] *= b, a[e + 1] *= b, a[e + 2] *= b
    },
    computeTangents: function () {
        function a(a) {
            ca.x = d[3 * a];
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 ===
            ...
            var n, p, m, r, s, l, q, u, B, x, t, F, C, A, z, f = new THREE.Vector3,
                g = new THREE.Vector3,
                H, G, I, $, D, L, y, J = this.offsets;
            I = 0;
            for ($ = J.length; I < $; ++I) {
                G = J[I].start;
                D = J[I].count;
                var K = J[I].index;
                H = G;
                for (G += D; H < G; H += 3) D = K + b[H], L = K + b[H + 1], y = K + b[H + 2], n = c[3 * D], p = c[3 * D + 1], m = c[3 * D + 2], r = c[3 * L], s = c[3 * L + 1], l = c[3 * L + 2], q = c[3 * y], u = c[3 * y + 1], B = c[3 * y + 2], x = e[2 * D], t = e[2 * D + 1], F = e[2 * L], C = e[2 * L + 1], A = e[2 * y], z = e[2 * y + 1], r -= n, n = q - n, s -= p, p = u - p, l -= m, m = B - m, F -= x, x = A - x, C -= t, t = z - t, z = 1 / (F * t - x * C), f.set((t * r - C * n) * z, (t * s - C * p) * z, (t * l - C * m) * z), g.set((F *
                    n - x * r) * z, (F * p - x * s) * z, (F * m - x * l) * z), i[D].addSelf(f), i[L].addSelf(f), i[y].addSelf(f), k[D].addSelf(g), k[L].addSelf(g), k[y].addSelf(g)
            }
            ...
            for ($ = J.length; I < $; ++I) {
                ...
                K = J[I].index;
                H = G;
                for (G += D; H < G; H += 3) D = K + b[H], L = K + b[H + 1], y = K + b[H + 2], a(D), a(L), a(y)
            }
...
THREE.BinaryLoader.prototype.createBinModel = function (a, b, c, d) {
    var e = function () {
        ...
        function z(b, c) {
            var d, e, f, g, h, i, k, n = new Uint32Array(a, c, 3 * b);
            for (d = 0; d < b; d++) e = n[3 * d], f = n[3 * d + 1], g = n[3 * d + 2], h = K[2 * e], e = K[2 * e + 1], i = K[2 * f], k = K[2 * f + 1], f = K[2 * g], g = K[2 * g + 1], L.faceVertexUvs[0].push([new THREE.Vector2(h, e), new THREE.Vector2(i, k), new THREE.Vector2(f,
                g)])
        }

        function H(b, c) {
            var d, e, f, g, h, i, k, n, m, p = new Uint32Array(a, c, 4 * b);
            for (d = 0; d < b; d++) e = p[4 * d], f = p[4 * d + 1], g = p[4 * d + 2], h = p[4 * d + 3], i = K[2 * e], e = K[2 * e + 1], k = K[2 * f], n = K[2 * f + 1], f = K[2 * g], m = K[2 * g + 1], g = K[2 * h], h = K[2 * h + 1], L.faceVertexUvs[0].push([new THREE.Vector2(i, e), new THREE.Vector2(k, n), new THREE.Vector2(f, m), new THREE.Vector2(g, h)])
        }

        function G(b, c, d) {
            for (var e, f, g, h, c = new Uint32Array(a, c, 3 * b), i = new Uint16Array(a, d, b), d = 0; d < b; d++) e = c[3 * d], f = c[3 * d + 1], g = c[3 * d + 2], h = i[d], L.faces.push(new THREE.Face3(e, f, g, null,
                null, h))
        }

        function I(b, c, d) {
            for (var e, f, g, h, i, c = new Uint32Array(a, c, 4 * b), k = new Uint16Array(a, d, b), d = 0; d < b; d++) e = c[4 * d], f = c[4 * d + 1], g = c[4 * d + 2], h = c[4 * d + 3], i = k[d], L.faces.push(new THREE.Face4(e, f, g, h, null, null, i))
        }

        function $(b, c, d, e) {
            for (var f, g, h, i, k, n, m, c = new Uint32Array(a, c, 3 * b), d = new Uint32Array(a, d, 3 * b), p = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                f = c[3 * e];
                g = c[3 * e + 1];
                h = c[3 * e + 2];
                k = d[3 * e];
                ...
                var s = J[3 * m],
                    q = J[3 * m + 1];
                m = J[3 * m + 2];
                L.faces.push(new THREE.Face3(f,
                    g, h, [new THREE.Vector3(J[3 * k], J[3 * k + 1], J[3 * k + 2]), new THREE.Vector3(r, l, n), new THREE.Vector3(s, q, m)], null, i))
            }
        }

        function D(b, c, d, e) {
            for (var f, g, h, i, k, n, m, p, r, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), l = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                f = c[4 * e];
                g = c[4 * e + 1];
                h = c[4 * e + 2];
                i = c[4 * e + 3];
                ...
                var x = J[3 * r],
                    z = J[3 * r + 1];
                r = J[3 * r + 2];
                L.faces.push(new THREE.Face4(f, g, h, i, [new THREE.Vector3(J[3 *
                    n], J[3 * n + 1], J[3 * n + 2]), new THREE.Vector3(s, q, m), new THREE.Vector3(t, u, p), new THREE.Vector3(x, z, r)], null, k))
            }
        }
        var L = this,
            y = 0,
        ...
        var y = new Float32Array(a, y, 3 * n),
            xa, M, pa, ya;
        for (xa = 0; xa < n; xa++) M = y[3 * xa], pa = y[3 * xa + 1], ya = y[3 * xa + 2], L.vertices.push(new THREE.Vector3(M, pa, ya));
        n = y = ca + 3 * n * Float32Array.BYTES_PER_ELEMENT;
        if (p) {
            y = new Int8Array(a, y, 3 * p);
            for (ca = 0; ca < p; ca++) xa = y[3 * ca], M = y[3 * ca + 1], pa = y[3 * ca + 2], J.push(xa / 127, M / 127, pa / 127)
        }
        ...
        k = P + d + F(2 * B);
        d = k + e + F(2 * x);
        l && (e = p + 3 * l * Uint32Array.BYTES_PER_ELEMENT, G(l, p, e + 3 * l * Uint32Array.BYTES_PER_ELEMENT), z(l, e));
        q && (l = b + 3 * q * Uint32Array.BYTES_PER_ELEMENT, e = l + 3 * q * Uint32Array.BYTES_PER_ELEMENT, $(q, b, l, e + 3 * q * Uint32Array.BYTES_PER_ELEMENT), z(q, e));
        x && (q = k + 4 * x * Uint32Array.BYTES_PER_ELEMENT, I(x, k, q + 4 * x * Uint32Array.BYTES_PER_ELEMENT), H(x, q));
        t && (x = d + 4 * t * Uint32Array.BYTES_PER_ELEMENT,
            q = x + 4 * t * Uint32Array.BYTES_PER_ELEMENT, D(t, d, x, q + 4 * t * Uint32Array.BYTES_PER_ELEMENT), H(t, q));
        r && G(r, m, m + 3 * r * Uint32Array.BYTES_PER_ELEMENT);
        s && (r = R + 3 * s * Uint32Array.BYTES_PER_ELEMENT, $(s, R, r, r + 3 * s * Uint32Array.BYTES_PER_ELEMENT));
        u && I(u, c, c + 4 * u * Uint32Array.BYTES_PER_ELEMENT);
        B && (s = P + 4 * B * Uint32Array.BYTES_PER_ELEMENT, D(B, P, s, s + 4 * B * Uint32Array.BYTES_PER_ELEMENT));
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
    var d = new THREE.Geometry,
        ...
        f, g, h, i, k, n, p, m, r, s, l, q, u, B, x, t = a.faces;
    s = a.vertices;
    var F = a.normals,
        C = a.colors,
        A = 0;
    ...
    i = 0;
    for (k = s.length; i < k;) n = new THREE.Vector3, n.x = s[i++] * e, n.y = s[i++] * e, n.z = s[i++] * e, d.vertices.push(n);
    i = 0;
    for (k = t.length; i < k;) {
        s = t[i++];
        n = s & 1;
        ...
        s &= 128;
        n ? (q = new THREE.Face4,
            q.a = t[i++], q.b = t[i++], q.c = t[i++], q.d = t[i++], n = 4) : (q = new THREE.Face3, q.a = t[i++], q.b = t[i++], q.c = t[i++], n = 3);
        h && (h = t[i++], q.materialIndex = h);
        h = d.faces.length;
        if (f)
            for (f = 0; f < A; f++) u = a.uvs[f], r = t[i++], x = u[2 * r], r = u[2 * r + 1], d.faceUvs[f][h] = new THREE.Vector2(x, r);
        if (g)
            for (f = 0; f < A; f++) {
                u = a.uvs[f];
                B = [];
                for (g = 0; g < n; g++) r = t[i++], x = u[2 * r], r = u[2 * r + 1], B[g] = new THREE.Vector2(x, r);
                d.faceVertexUvs[f][h] = B
            }
        m && (m = 3 * t[i++], g = new THREE.Vector3, g.x = F[m++], g.y = F[m++], g.z = F[m], q.normal = g);
        if (p)
            for (f = 0; f < n; f++) m = 3 * t[i++], g =
                new THREE.Vector3, g.x = F[m++], g.y = F[m++], g.z = F[m], q.vertexNormals.push(g);
        l && (p = t[i++], p = new THREE.Color(C[p]), q.color = p);
        if (s)
            for (f = 0; f < n; f++) p = t[i++], p = new THREE.Color(C[p]), q.vertexColors.push(p);
        d.faces.push(q)
    }
    if (a.skinWeights) {
        i = 0;
        for (k = a.skinWeights.length; i < k; i += 2) t = a.skinWeights[i], F = a.skinWeights[i + 1], d.skinWeights.push(new THREE.Vector4(t, F, 0, 0))
    }
    if (a.skinIndices) {
        i = 0;
        for (k = a.skinIndices.length; i < k; i += 2) t = a.skinIndices[i], F = a.skinIndices[i + 1], d.skinIndices.push(new THREE.Vector4(t, F, 0, 0))
    }
    d.bones =
        a.bones;
    ...
    if (void 0 !== a.morphTargets) {
        ...
        for (k = a.morphTargets.length; i < k; i++) {
            ...
            t = 0;
            for (F = A.length; t < F; t += 3) s = new THREE.Vector3, s.x = A[t] * e, s.y = A[t + 1] * e, s.z = A[t + 2] * e, C.push(s)
        }
    }
    if (void 0 !== a.morphColors) {
        ...
        for (k = a.morphColors.length; i < k; i++) {
            ...
            e = 0;
            for (t = C.length; e < t; e += 3) A = new THREE.Color(16755200), A.setRGB(C[e], C[e + 1], C[e + 2]), F.push(A)
        }
    }
    d.computeCentroids();
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
            ...
            if (void 0 === z.objects[p]) {
                ...
                if (l.type && l.type in n.hierarchyHandlerMap) {
                    if (void 0 === l.loading) {
                        ...
                        c.options ? c.load(d(l.url, G.urlBaseType), h(p, a, r, l)) : c.load(d(l.url, G.urlBaseType), h(p, a, r, l), e)
                    }
                    ...
                    if (m = z.geometries[l.geometry]) {
                        ...
                        c = l.matrix;
                        k = l.quaternion;
                        l.material || (r = new THREE.MeshFaceMaterial(z.face_materials[l.geometry]));
                        r instanceof THREE.MeshFaceMaterial && 0 === r.materials.length && (r = new THREE.MeshFaceMaterial(z.face_materials[l.geometry]));
                        if (r instanceof THREE.MeshFaceMaterial)
                            for (var y = 0; y < r.materials.length; y++) q = q || r.materials[y] instanceof THREE.ShaderMaterial;
                        q && m.computeTangents();
                        l.skin ? q = new THREE.SkinnedMesh(m, r) : l.morph ? (q = new THREE.MorphAnimMesh(m, r), void 0 !== l.duration && (q.duration = l.duration), void 0 !== l.time && (q.time = l.time), void 0 !== l.mirroredLoop && (q.mirroredLoop = l.mirroredLoop), r.morphNormals && m.computeMorphNormals()) : q = new THREE.Mesh(m, r);
                        q.name = p;
                        c ? (q.matrixAutoUpdate = !1, q.matrix.set(c[0], c[1], c[2], c[3], c[4], c[5],
                            c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[14], c[15])) : (q.position.set(e[0], e[1], e[2]), k ? (q.quaternion.set(k[0], k[1], k[2], k[3]), q.useQuaternion = !0) : q.rotation.set(g[0], g[1], g[2]), q.scale.set(i[0], i[1], i[2]));
                        q.visible = l.visible;
    ...
    var n = this,
        ...
        m, r, s, l, q, u, B, x, t, F, C, A, z, H = [],
        G = a,
        I;
    for (I in this.geometryHandlerMap) a = this.geometryHandlerMap[I].loaderClass, this.geometryHandlerMap[I].loaderObject = new a;
    for (I in this.hierarchyHandlerMap) a = this.hierarchyHandlerMap[I].loaderClass, this.hierarchyHandlerMap[I].loaderObject = new a;
    F = t = 0;
    z = {
    ...
    if (G.transform && (I = G.transform.position, a = G.transform.rotation, c = G.transform.scale, I && z.scene.position.set(I[0], I[1], I[2]), a && z.scene.rotation.set(a[0], a[1], a[2]), c && z.scene.scale.set(c[0], c[1], c[2]), I || a || c)) z.scene.updateMatrix(), z.scene.updateMatrixWorld();
    I = function (a) {
        return function () {
            F -= a;
            k();
    ...
    for (var $ in G.fogs) a = G.fogs[$], "linear" === a.type ? l = new THREE.Fog(0, a.near, a.far) : "exp2" === a.type && (l = new THREE.FogExp2(0, a.density)),
        a = a.color, l.color.setRGB(a[0], a[1], a[2]), z.fogs[$] = l;
    for (var D in G.geometries) l = G.geometries[D], l.type in this.geometryHandlerMap && (t += 1, n.onLoadStart());
    for (var L in G.objects) l = G.objects[L], l.type && l.type in this.hierarchyHandlerMap && (t += 1, n.onLoadStart());
    C = t;
    for (D in G.geometries)
        if (l = G.geometries[D], "cube" === l.type) m = new THREE.CubeGeometry(l.width, l.height, l.depth, l.widthSegments, l.heightSegments, l.depthSegments), z.geometries[D] = m;
        else if ("plane" === l.type) m = new THREE.PlaneGeometry(l.width, l.height,
        l.widthSegments, l.heightSegments), z.geometries[D] = m;
    else if ("sphere" === l.type) m = new THREE.SphereGeometry(l.radius, l.widthSegments, l.heightSegments), z.geometries[D] = m;
    else if ("cylinder" === l.type) m = new THREE.CylinderGeometry(l.topRad, l.botRad, l.height, l.radSegs, l.heightSegs), z.geometries[D] = m;
    else if ("torus" === l.type) m = new THREE.TorusGeometry(l.radius, l.tube, l.segmentsR, l.segmentsT), z.geometries[D] = m;
    else if ("icosahedron" === l.type) m = new THREE.IcosahedronGeometry(l.radius, l.subdivisions), z.geometries[D] =
        m;
    else if (l.type in this.geometryHandlerMap) {
        L = {};
        for (q in l) "type" !== q && "url" !== q && (L[q] = l[q]);
        this.geometryHandlerMap[l.type].loaderObject.load(d(l.url, G.urlBaseType), g(D), L)
    } else "embedded" === l.type && (L = G.embeds[l.id], L.metadata = G.metadata, L && this.geometryHandlerMap.ascii.loaderObject.createModel(L, i(D), ""));
    ...
    for (y in G.textures) {
        D = G.textures[y];
        void 0 !== D.mapping && void 0 !== THREE[D.mapping] && (D.mapping = new THREE[D.mapping]);
        if (D.url instanceof Array) {
            L = D.url.length;
            l = [];
            for (q = 0; q < L; q++) l[q] = d(D.url[q], G.urlBaseType);
            q = (q = l[0].endsWith(".dds")) ? THREE.ImageUtils.loadCompressedTextureCube(l, D.mapping, I(L)) : THREE.ImageUtils.loadTextureCube(l, D.mapping, I(L))
        } else q = D.url.toLowerCase().endsWith(".dds"), L = d(D.url, G.urlBaseType), l = I(1), q = q ? THREE.ImageUtils.loadCompressedTexture(L, D.mapping, l) : THREE.ImageUtils.loadTexture(L, D.mapping, l), void 0 !==
            THREE[D.minFilter] && (q.minFilter = THREE[D.minFilter]), void 0 !== THREE[D.magFilter] && (q.magFilter = THREE[D.magFilter]), D.anisotropy && (q.anisotropy = D.anisotropy), D.repeat && (q.repeat.set(D.repeat[0], D.repeat[1]), 1 !== D.repeat[0] && (q.wrapS = THREE.RepeatWrapping), 1 !== D.repeat[1] && (q.wrapT = THREE.RepeatWrapping)), D.offset && q.offset.set(D.offset[0], D.offset[1]), D.wrap && (L = {
                repeat: THREE.RepeatWrapping,
                mirror: THREE.MirroredRepeatWrapping
            }, void 0 !== L[D.wrap[0]] && (q.wrapS = L[D.wrap[0]]), void 0 !== L[D.wrap[1]] && (q.wrapT =
                L[D.wrap[1]]));
        z.textures[y] = q
    }
    var J, K;
    for (J in G.materials) {
        y = G.materials[J];
        for (K in y.parameters) "envMap" === K || "map" === K || "lightMap" === K || "bumpMap" === K ? y.parameters[K] = z.textures[y.parameters[K]] : "shading" === K ? y.parameters[K] = "flat" === y.parameters[K] ? THREE.FlatShading : THREE.SmoothShading : "side" === K ? y.parameters[K] = "double" == y.parameters[K] ? THREE.DoubleSide : "back" == y.parameters[K] ? THREE.BackSide : THREE.FrontSide : "blending" === K ? y.parameters[K] = y.parameters[K] in THREE ? THREE[y.parameters[K]] : THREE.NormalBlending :
            "combine" === K ? y.parameters[K] = y.parameters[K] in THREE ? THREE[y.parameters[K]] : THREE.MultiplyOperation : "vertexColors" === K ? "face" == y.parameters[K] ? y.parameters[K] = THREE.FaceColors : y.parameters[K] && (y.parameters[K] = THREE.VertexColors) : "wrapRGB" === K && (I = y.parameters[K], y.parameters[K] = new THREE.Vector3(I[0], I[1], I[2]));
        void 0 !== y.parameters.opacity && 1 > y.parameters.opacity && (y.parameters.transparent = !0);
        y.parameters.normalMap ? (I = THREE.ShaderUtils.lib.normal, D = THREE.UniformsUtils.clone(I.uniforms), q = y.parameters.color,
            ...
            (D.uOpacity.value = y.parameters.opacity), r = new THREE.ShaderMaterial({
    ...
    for (J in G.materials)
        if (y = G.materials[J], y.parameters.materials) {
            K = [];
            for (q = 0; q < y.parameters.materials.length; q++) K.push(z.materials[y.parameters.materials[q]]);
            z.materials[J].materials = K
        } e();
    z.cameras && G.defaults.camera && (z.currentCamera = z.cameras[G.defaults.camera]);
    z.fogs && G.defaults.fog &&
        (z.scene.fog = z.fogs[G.defaults.fog]);
...
THREE.Mesh = function (a, b) {
    ...
    if (this.geometry && (null === this.geometry.boundingSphere && this.geometry.computeBoundingSphere(), this.geometry.morphTargets.length)) {
        ...
        for (var c = 0; c < this.geometry.morphTargets.length; c++) this.morphTargetInfluences.push(0), this.morphTargetDictionary[this.geometry.morphTargets[c].name] =
            c
    }
};
...
THREE.CanvasRenderer = function (a) {
    ...
    function c(a) {
        x !== a && (a === THREE.NormalBlending ? l.globalCompositeOperation = "source-over" : a === THREE.AdditiveBlending ? l.globalCompositeOperation = "lighter" : a === THREE.SubtractiveBlending && (l.globalCompositeOperation = "darker"), x = a)
    }
    ...
    var a = a || {},
        f = this,
        g, h, i, k = new THREE.Projector,
        n = void 0 !== a.canvas ? a.canvas :
        document.createElement("canvas"),
        p, m, r, s, l = n.getContext("2d"),
        q = new THREE.Color(0),
        u = 0,
        B = 1,
        x = 0,
        ...
        A = null,
        z = null,
        H, G, I, $, D = new THREE.RenderableVertex,
        L = new THREE.RenderableVertex,
        y, J, K, R, P, ca, xa, M, pa, ya, ua, N, O = new THREE.Color,
        aa = new THREE.Color,
        fa = new THREE.Color,
        V = new THREE.Color,
        ja = new THREE.Color,
        ...
        oa = {},
        za = {},
        Da, Ta, sa, nb, Bb, kb, eb, pb, jc, Lb, Ua = new THREE.Box2,
        ma = new THREE.Box2,
        Ra = new THREE.Box2,
        Cb = !1,
        Ha = new THREE.Color,
    ...
    this.clear = function () {
        ...
        !1 === ma.empty() && (ma.intersect(Ua), ma.expandByScalar(2), 1 > u && l.clearRect(ma.min.x | 0, ma.min.y | 0, ma.max.x - ma.min.x | 0, ma.max.y - ma.min.y | 0), 0 < u && (c(THREE.NormalBlending), b(1), e("rgba(" + Math.floor(255 * q.r) + "," + Math.floor(255 * q.g) + "," + Math.floor(255 * q.b) + "," + u + ")"), l.fillRect(ma.min.x | 0, ma.min.y | 0, ma.max.x - ma.min.x | 0, ma.max.y - ma.min.y | 0)), ma.makeEmpty())
    };
    this.render = function (a,
            ...
            for (var d = 0, e = i.length; d < e; d++) {
                ...
                if (f instanceof THREE.DirectionalLight) {
                    var h = f.matrixWorld.getPosition().normalize(),
                        j = b.dot(h);
                    0 >= j || (j *= f.intensity, c.r += g.r * j, c.g += g.g * j, c.b += g.b * j)
                } else f instanceof THREE.PointLight && (h = f.matrixWorld.getPosition(), j = b.dot(Oa.sub(h, a).normalize()), 0 >= j || (j *= 0 == f.distance ? 1 : 1 - Math.min(a.distanceTo(h) / f.distance, 1), 0 != j && (j *= f.intensity, c.r += g.r * j, c.g += g.g * j, c.b += g.b * j)))
            }
        }
        ...
        function m(a, d, e, g, h, i, k, da) {
            ...
            p(y, J, K, R, P, ca);
            (da instanceof THREE.MeshLambertMaterial || da instanceof THREE.MeshPhongMaterial) && null === da.map && null === da.map ? (Z.copy(da.color), ga.copy(da.emissive), da.vertexColors === THREE.FaceColors && (Z.r *= k.color.r, Z.g *= k.color.g, Z.b *= k.color.b), !0 === Cb ? !1 === da.wireframe && da.shading == THREE.SmoothShading && 3 == k.vertexNormalsLength ?
        ...
        function x(a, b, c, d, f, g, h, j, i, k, da, n, m) {
            if (!(m instanceof THREE.DataTexture || void 0 === m.image || 0 == m.image.width)) {
                if (!0 === m.needsUpdate) {
                    ...
                    oa[m.id] = l.createPattern(m.image, !0 === p && !0 === r ? "repeat" :
                        !0 === p && !1 === r ? "repeat-x" : !1 === p && !0 === r ? "repeat-y" : "no-repeat");
                    m.needsUpdate = !1
                }
                ...
                var p = m.offset.x / m.repeat.x,
                    ...
                    n = (1 - n + r) * q - j,
                    p = i * n - da * k;
                0 === p ? (void 0 === za[m.id] && (b = document.createElement("canvas"), b.width = m.image.width, b.height = m.image.height, b = b.getContext("2d"), b.drawImage(m.image, 0, 0),
                    za[m.id] = b.getImageData(0, 0, m.image.width, m.image.height).data), b = za[m.id], h = 4 * (Math.floor(h) + Math.floor(j) * m.image.width), O.setRGB(b[h] / 255, b[h + 1] / 255, b[h + 2] / 255), u(O)) : (p = 1 / p, m = (n * c - k * f) * p, k = (n * d - k * g) * p, c = (i * f - da * c) * p, d = (i * g - da * d) * p, a = a - m * h - c * j, h = b - k * h - d * j, l.save(), l.transform(m, k, c, d, a, h), l.fill(), l.restore())
            }
        }
        ...
        if (!1 === j instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            if (!0 === Cb) {
                ...
                fb.setRGB(0, 0, 0);
                for (var zb =
                        0, Mb = i.length; zb < Mb; zb++) {
                    var X = i[zb],
                        la = X.color;
                    X instanceof THREE.AmbientLight ? (Ha.r += la.r, Ha.g += la.g, Ha.b += la.b) : X instanceof THREE.DirectionalLight ? (qb.r += la.r, qb.g += la.g, qb.b += la.b) : X instanceof THREE.PointLight && (fb.r += la.r, fb.g += la.g, fb.b += la.b)
                }
            }
            zb = 0;
                ...
                if (!(void 0 === X || !1 === X.visible)) {
                    ...
                    THREE.RenderableLine ? (H = ka.v1, G = ka.v2, H.positionScreen.x *= r, H.positionScreen.y *= s, G.positionScreen.x *= r, G.positionScreen.y *= s, Ra.setFromPoints([H.positionScreen, G.positionScreen]), !0 === Ua.isIntersectionBox(Ra) && (la = H, $a = G, b(X.opacity), c(X.blending), l.beginPath(), l.moveTo(la.positionScreen.x, la.positionScreen.y), l.lineTo($a.positionScreen.x, $a.positionScreen.y), X instanceof THREE.LineBasicMaterial && (la = X.linewidth, C !== la && (C = l.lineWidth = la), la = X.linecap, A !== la && (A = l.lineCap = la), la = X.linejoin, z !== la &&
                        ...
                        ca = Wa.positionScreen.y, xa = ab.positionScreen.x, M = ab.positionScreen.y, pa = ob.positionScreen.x, ya = ob.positionScreen.y, ua = hb.positionScreen.x, N = hb.positionScreen.y, X instanceof THREE.MeshLambertMaterial || X instanceof THREE.MeshPhongMaterial ? (Z.copy(X.color), ga.copy(X.emissive), X.vertexColors === THREE.FaceColors && (Z.r *= ka.color.r, Z.g *= ka.color.g, Z.b *= ka.color.b), !0 === Cb ? !1 === X.wireframe && X.shading == THREE.SmoothShading && 4 == ka.vertexNormalsLength ? (aa.r = fa.r = V.r = ja.r = Ha.r, aa.g = fa.g = V.g = ja.g = Ha.g, aa.b = fa.b =
                            ...
                            1 - Va($a.positionScreen.z, Da, Ta), V.r = V.g = V.b = 1 - Va(ab.positionScreen.z, Da, Ta), ja.r = ja.g = ja.b = 1 - Va(Wa.positionScreen.z, Da, Ta), sa = F(aa, fa, V, ja), p(y, J, K, R, xa, M), B(y, J, K, R, xa, M, 0, 0, 1, 0, 0, 1, sa), p(pa, ya, P, ca, ua, N), B(pa, ya, P, ca, ua, N, 1, 0, 1, 1, 0, 1, sa)))));
                    ma.union(Ra)
                }
            }
...
THREE.ShaderLib = {
    ...
    dashed: {
        ...
        fragmentShader: ["uniform vec3 diffuse;\nuniform float opacity;\nuniform float dashSize;\nuniform float totalSize;\nvarying float vLineDistance;",
            THREE.ShaderChunk.color_pars_fragment, THREE.ShaderChunk.fog_pars_fragment, "void main() {\nif ( mod( vLineDistance, totalSize ) > dashSize ) {\ndiscard;\n}\ngl_FragColor = vec4( diffuse, opacity );", THREE.ShaderChunk.color_fragment, THREE.ShaderChunk.fog_fragment, "}"
        ].join("\n")
    },
    depthRGBA: {
        uniforms: {},
...
THREE.WebGLRenderer = function (a) {
    ...
    function r(a, b, c) {
        if (a.length)
            for (var d = 0, e = a.length; d < e; d++) ga =
                fa = null, ja = Z = Ta = Da = pb = eb = sa = -1, Va = !0, a[d].render(b, c, fb, Oa), ga = fa = null, ja = Z = Ta = Da = pb = eb = sa = -1, Va = !0
    }
        ...
        for (var m = i; m !== b; m += n)
            if (j = a[m], j.render) {
                ...
                if (h) j = h;
                    ...
                    j = j[c];
                    if (!j) continue;
                    g && N.setBlending(j.blending, j.blendEquation, j.blendSrc, j.blendDst);
                ...
                k instanceof
                THREE.BufferGeometry ? N.renderBufferDirect(d, e, f, j, k, i) : N.renderBuffer(d, e, f, j, k, i)
            }
    }
    ...
    function F(a, b, c, d, e) {
        za = 0;
        d.needsUpdate && (d.program && hb(d), N.initMaterial(d, b, c, e), d.needsUpdate = !1);
        ...
        d.id !== ja && (ja = d.id, f = !0);
        if (f || a !== ga) j.uniformMatrix4fv(h.projectionMatrix, !1, a.projectionMatrix.elements), a !== ga && (ga = a);
        if (d.skinning)
        ...
        if (f) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (Va) {
                    for (var n, m = k = 0, l = 0, p, r, s, q = Jc, t = q.directional.colors, u = q.directional.positions, x = q.point.colors, y = q.point.positions, B = q.point.distances, A = q.spot.colors, F = q.spot.positions, G = q.spot.distances, O = q.spot.directions, I = q.spot.anglesCos, L = q.spot.exponents, V = q.hemi.skyColors, M = q.hemi.groundColors, Z = q.hemi.positions,
                        ...
                        p, r), aa += 1))) : n instanceof THREE.PointLight ? (la += 1, n.visible && (W = 3 * R, N.gammaInput ? z(x, W, p, r * r) : H(x, W, p, r), r = n.matrixWorld.getPosition(), y[W] = r.x, y[W + 1] = r.y, y[W + 2] = r.z, B[R] = s, R += 1)) : n instanceof THREE.SpotLight ? (ka += 1, n.visible && (W = 3 * P, N.gammaInput ? z(A, W, p, r * r) : H(A, W, p, r), r = n.matrixWorld.getPosition(), F[W] = r.x, F[W + 1] = r.y, F[W + 2] = r.z, G[P] = s, Ea.copy(r), Ea.subSelf(n.target.matrixWorld.getPosition()), Ea.normalize(), O[W] = Ea.x, O[W + 1] = Ea.y, O[W + 2] = Ea.z, I[P] = Math.cos(n.angle), L[P] = n.exponent, P += 1)) : n instanceof THREE.HemisphereLight && (ca += 1, n.visible && (Ea.copy(n.matrixWorld.getPosition()), Ea.normalize(), 0 === Ea.x && 0 === Ea.y && 0 === Ea.z || (s = 3 * X, Z[s] = Ea.x, Z[s + 1] = Ea.y, Z[s + 2] = Ea.z, p = n.color, n = n.groundColor, N.gammaInput ? (r *= r, z(V, s, p, r), z(M, s, n, r)) : (H(V, s, p, r), H(M, s, n, r)), X += 1))));
                    c = 3 * aa;
            ...
            if (d instanceof THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.MeshPhongMaterial) {
                ...
                N.gammaInput ? i.diffuse.value.copyGammaToLinear(d.color) :
                ...
                var oa;
                d.map ? oa = d.map : d.specularMap ? oa = d.specularMap : d.normalMap ? oa = d.normalMap : d.bumpMap && (oa = d.bumpMap);
                void 0 !== oa && (c = oa.offset, oa = oa.repeat, i.offsetRepeat.value.set(c.x, c.y, oa.x, oa.y));
            ...
            d instanceof THREE.LineBasicMaterial ? (i.diffuse.value = d.color, i.opacity.value = d.opacity) : d instanceof THREE.LineDashedMaterial ? (i.diffuse.value = d.color, i.opacity.value = d.opacity, i.dashSize.value = d.dashSize, i.totalSize.value = d.dashSize + d.gapSize, i.scale.value = d.scale) : d instanceof
            ...
            if (e.receiveShadow && !d._shadowPass && i.shadowMatrix) {
                ...
                for (f = b.length; c < f; c++)
                    if (k = b[c],
                        k.castShadow && (k instanceof THREE.SpotLight || k instanceof THREE.DirectionalLight && !k.shadowCascade)) i.shadowMap.value[oa] = k.shadowMap, i.shadowMapSize.value[oa] = k.shadowMapSize, i.shadowMatrix.value[oa] = k.shadowMatrix, i.shadowDarkness.value[oa] = k.shadowDarkness, i.shadowBias.value[oa] = k.shadowBias, oa++
            }
            b = d.uniformsList;
            i = 0;
            for (oa = b.length; i < oa; i++)
                ...
                m = 0;
                for (l = k.length; m < l; m++) q = 2 * m, c._array[q] = k[m].x, c._array[q + 1] = k[m].y;
                j.uniform2fv(f, c._array)
            } else if ("v3v" === m) {
                void 0 === c._array && (c._array =
                    new Float32Array(3 * k.length));
                m = 0;
                for (l = k.length; m < l; m++) q = 3 * m, c._array[q] = k[m].x, c._array[q + 1] = k[m].y, c._array[q + 2] = k[m].z;
                j.uniform3fv(f, c._array)
            } else if ("v4v" === m) {
                void 0 === c._array && (c._array = new Float32Array(4 * k.length));
                m = 0;
                for (l = k.length; m < l; m++) q = 4 * m, c._array[q] = k[m].x, c._array[q + 1] = k[m].y, c._array[q + 2] = k[m].z, c._array[q + 3] = k[m].w;
                ...
                m = 0;
                for (l = k.length; m < l; m++) k[m].flattenToArrayOffset(c._array, 16 * m);
                    ...
                    if (q.image instanceof Array && 6 === q.image.length) {
                        if (c = q, f = k, 6 === c.image.length)
                            if (c.needsUpdate) {
                                ...
                                k = [];
                                for (m = 0; 6 > m; m++) N.autoScaleCubemaps && !f ? (l = k, q = m, t = c.image[m], x = bd, t.width <= x && t.height <= x || (y = Math.max(t.width, t.height), u = Math.floor(t.width * x / y), x = Math.floor(t.height * x / y), y = document.createElement("canvas"), y.width = u, y.height = x, y.getContext("2d").drawImage(t, 0, 0, t.width, t.height, 0, 0, u, x), t = y), l[q] = t) : k[m] = c.image[m];
                                m = k[0];
                                l = 0 === (m.width & m.width - 1) && 0 === (m.height & m.height - 1);
                                q = J(c.format);
                                t = J(c.type);
                                ...
                                for (m = 0; 6 > m; m++)
                                    if (f) {
                                        x = k[m].mipmaps;
                                        y = 0;
                                        for (B = x.length; y < B; y++) u = x[y], j.compressedTexImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X + m, y, q, u.width, u.height, 0, u.data)
                                    } else j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X + m, 0, q, q, t, k[m]);
                                c.generateMipmaps && l && j.generateMipmap(j.TEXTURE_CUBE_MAP);
                                c.needsUpdate = !1;
                                if (c.onUpdate) c.onUpdate()
                            } else j.activeTexture(j.TEXTURE0 + f), j.bindTexture(j.TEXTURE_CUBE_MAP, c.image.__webglTextureCube)
                    } else q instanceof THREE.WebGLRenderTargetCube ? (c = q, j.activeTexture(j.TEXTURE0 +
                        k), j.bindTexture(j.TEXTURE_CUBE_MAP, c.__webglTexture)) : N.setTexture(q, k)
            } else if ("tv" === m) {
                void 0 === c._array && (c._array = []);
                m = 0;
                ...
                m = 0;
                for (l = c.value.length; m < l; m++) q = c.value[m], k = c._array[m], q && N.setTexture(q, k)
            }
            if ((d instanceof THREE.ShaderMaterial || d instanceof THREE.MeshPhongMaterial || d.envMap) && null !== h.cameraPosition) b = a.matrixWorld.getPosition(), j.uniform3f(h.cameraPosition, b.x, b.y, b.z);
            (d instanceof THREE.MeshPhongMaterial ||
                d instanceof THREE.MeshLambertMaterial || d instanceof THREE.ShaderMaterial || d.skinning) && null !== h.viewMatrix && j.uniformMatrix4fv(h.viewMatrix, !1, a.matrixWorldInverse.elements)
        }
    ...
    function C() {
        var a = za;
        a >= Lc && console.warn("WebGLRenderer: trying to use " + a + " texture units while this GPU supports only " +
            Lc);
        za += 1;
        return a
    }
    ...
    function G(a, b, c) {
        jc !== a && (a ? j.enable(j.POLYGON_OFFSET_FILL) : j.disable(j.POLYGON_OFFSET_FILL), jc = a);
    ...
    function D(a, b, c) {
        c ? (j.texParameteri(a, j.TEXTURE_WRAP_S, J(b.wrapS)), j.texParameteri(a, j.TEXTURE_WRAP_T, J(b.wrapT)), j.texParameteri(a, j.TEXTURE_MAG_FILTER, J(b.magFilter)), j.texParameteri(a,
            j.TEXTURE_MIN_FILTER, J(b.minFilter))) : (j.texParameteri(a, j.TEXTURE_WRAP_S, j.CLAMP_TO_EDGE), j.texParameteri(a, j.TEXTURE_WRAP_T, j.CLAMP_TO_EDGE), j.texParameteri(a, j.TEXTURE_MAG_FILTER, y(b.magFilter)), j.texParameteri(a, j.TEXTURE_MIN_FILTER, y(b.minFilter)));
        if (dc && b.type !== THREE.FloatType && (1 < b.anisotropy || b.__oldAnisotropy)) j.texParameterf(a, dc.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, Kc)), b.__oldAnisotropy = b.anisotropy
    }
    ...
    function J(a) {
        ...
        if (void 0 !== Db) {
            if (a === THREE.RGB_S3TC_DXT1_Format) return Db.COMPRESSED_RGB_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT1_Format) return Db.COMPRESSED_RGBA_S3TC_DXT1_EXT;
            if (a === THREE.RGBA_S3TC_DXT3_Format) return Db.COMPRESSED_RGBA_S3TC_DXT3_EXT;
            if (a === THREE.RGBA_S3TC_DXT5_Format) return Db.COMPRESSED_RGBA_S3TC_DXT5_EXT
        }
        return 0
    }
    ...
    var a = a || {},
        ...
        xa = void 0 !== a.antialias ?
        a.antialias : !1,
        M = void 0 !== a.stencil ? a.stencil : !0,
        pa = void 0 !== a.preserveDrawingBuffer ? a.preserveDrawingBuffer : !1,
        ya = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0),
        ua = void 0 !== a.clearAlpha ? a.clearAlpha : 0;
    this.domElement = K;
    this.context = null;
    this.devicePixelRatio = void 0 !== a.devicePixelRatio ? a.devicePixelRatio : void 0 !== window.devicePixelRatio ? window.devicePixelRatio : 1;
    this.autoUpdateScene = this.autoUpdateObjects = this.sortObjects = this.autoClearStencil = this.autoClearDepth = this.autoClearColor =
        this.autoClear = !0;
    ...
    var N = this,
        ...
        j, qc, Bc, dc, Db;
    try {
        if (!(j = K.getContext("experimental-webgl", {
                alpha: P,
    ...
    dc = j.getExtension("EXT_texture_filter_anisotropic") || j.getExtension("MOZ_EXT_texture_filter_anisotropic") || j.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
    Db =
        j.getExtension("WEBGL_compressed_texture_s3tc") || j.getExtension("MOZ_WEBGL_compressed_texture_s3tc") || j.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");
    ...
    dc || console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");
    Db || console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");
    ...
    var bd = j.getParameter(j.MAX_CUBE_MAP_TEXTURE_SIZE),
        Kc = dc ? j.getParameter(dc.MAX_TEXTURE_MAX_ANISOTROPY_EXT) :
        0,
        rc = 0 < dd,
        gb = rc && qc;
    ...
    "highp" === R && !la && (ka ? (R = "mediump", console.warn("WebGLRenderer: highp not supported, using mediump")) : (R = "lowp", console.warn("WebGLRenderer: highp and mediump not supported, using lowp")));
    "mediump" ===
    R && !ka && (R = "lowp", console.warn("WebGLRenderer: mediump not supported, using lowp"));
    ...
    var $a = function (a) {
            ...
            void 0 !==
                a.__webglSkinWeightsBuffer && j.deleteBuffer(a.__webglSkinWeightsBuffer);
        ...
        hb = function (a) {
            ...
            if (void 0 !== b) {
                ...
                for (c = O.length; a < c; a++)
                    ...
                    e = [];
                    a = 0;
                    for (c = O.length; a < c; a++) d = O[a], d.program !== b && e.push(d);
                    O = e;
                    j.deleteProgram(b);
    ...
    this.renderBufferImmediate = function (a, b, c) {
        ...
        if (a.hasNormals) {
            ...
            if (c.shading === THREE.FlatShading) {
                var d, e, f, g, h, i, k, n, m, l, p, r = 3 * a.count;
                for (p = 0; p < r; p += 9) l = a.normalArray, d = l[p], e = l[p + 1], f = l[p + 2], g = l[p + 3], i = l[p + 4], n = l[p + 5], h = l[p + 6], k = l[p + 7], m = l[p + 8], d = (d + g + h) / 3, e = (e + i + k) / 3, f = (f + n + m) / 3, l[p] = d, l[p + 1] = e, l[p +
                    2] = f, l[p + 3] = d, l[p + 4] = e, l[p + 5] = f, l[p + 6] = d, l[p + 7] = e, l[p + 8] = f
            }
    ...
    this.renderBufferDirect = function (a, b, c, d, e, f) {
        if (!1 !== d.visible)
            if (c = F(a, b, c, d, f), a = c.attributes, b = !1, d = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0), d !== Z && (Z = d, b = !0), b && n(), f instanceof THREE.Mesh)
                if (f = e.attributes.index) {
                    ...
                    for (var c = 0, g = d.length; c <
                        ...
                        if (b) {
                            ...
                            m = e.attributes.uv;
                            0 <= a.uv && m && (l = m.itemSize, j.bindBuffer(j.ARRAY_BUFFER, m.buffer), k(a.uv), j.vertexAttribPointer(a.uv, l, j.FLOAT, !1, 0, 4 * h * l));
                            m = e.attributes.color;
                            0 <=
                                a.color && m && (l = m.itemSize, j.bindBuffer(j.ARRAY_BUFFER, m.buffer), k(a.color), j.vertexAttribPointer(a.color, l, j.FLOAT, !1, 0, 4 * h * l));
                            m = e.attributes.tangent;
                            0 <= a.tangent && m && (l = m.itemSize, j.bindBuffer(j.ARRAY_BUFFER, m.buffer), k(a.tangent), j.vertexAttribPointer(a.tangent, l, j.FLOAT, !1, 0, 4 * h * l));
        ...
        else f instanceof THREE.ParticleSystem && b && (i = e.attributes.position, m = i.itemSize, j.bindBuffer(j.ARRAY_BUFFER, i.buffer), k(a.position), j.vertexAttribPointer(a.position,
            m, j.FLOAT, !1, 0, 0), m = e.attributes.color, 0 <= a.color && m && (l = m.itemSize, j.bindBuffer(j.ARRAY_BUFFER, m.buffer), k(a.color), j.vertexAttribPointer(a.color, l, j.FLOAT, !1, 0, 0)), j.drawArrays(j.POINTS, 0, i.numItems / 3), N.info.render.calls++, N.info.render.points += i.numItems / 3)
    };
    this.renderBuffer = function (a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            var g, h, c = F(a, b, c, d, f),
                b = c.attributes,
                a = !1,
            ...
            if (!d.morphTargets && 0 <= b.position) a && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglVertexBuffer),
                k(b.position), j.vertexAttribPointer(b.position, 3, j.FLOAT, !1, 0, 0));
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    h.length > d.numSupportedMorphTargets ? (h.sort(m), h.length = d.numSupportedMorphTargets) : h.length > d.numSupportedMorphNormals ? h.sort(m) : 0 === h.length && h.push([0, 0]);
                    for (i = 0; i < d.numSupportedMorphTargets;) h[i] ? (l = h[i][1], 0 <= c["morphTarget" + i] && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[l]), k(c["morphTarget" + i]), j.vertexAttribPointer(c["morphTarget" + i], 3, j.FLOAT, !1, 0, 0)), 0 <= c["morphNormal" + i] && d.morphNormals && (j.bindBuffer(j.ARRAY_BUFFER,
                        e.__webglMorphNormalsBuffers[l]), k(c["morphNormal" + i]), j.vertexAttribPointer(c["morphNormal" + i], 3, j.FLOAT, !1, 0, 0)), f.__webglMorphTargetInfluences[i] = g[l]) : f.__webglMorphTargetInfluences[i] = 0, i++
                }
            ...
            if (a) {
                if (e.__webglCustomAttributesList) {
                    g = 0;
                    for (h = e.__webglCustomAttributesList.length; g < h; g++) c = e.__webglCustomAttributesList[g], 0 <= b[c.buffer.belongsToAttribute] && (j.bindBuffer(j.ARRAY_BUFFER,
                        c.buffer), k(b[c.buffer.belongsToAttribute]), j.vertexAttribPointer(b[c.buffer.belongsToAttribute], c.size, j.FLOAT, !1, 0, 0))
                }
            ...
            f instanceof THREE.Mesh ? (d.wireframe ? (d = d.wireframeLinewidth, d !== ma && (j.lineWidth(d), ma = d), a && j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.__webglLineBuffer), j.drawElements(j.LINES, e.__webglLineCount, j.UNSIGNED_SHORT, 0)) : (a && j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer), j.drawElements(j.TRIANGLES, e.__webglFaceCount, j.UNSIGNED_SHORT,
    ...
    this.render = function (a, b, c, d) {
        if (!1 === b instanceof THREE.Camera) console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            for (e = h.length; d < e; d++)
                if (f = h[d], g = f.object, f.render = !1, g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || yb.contains(g))) {
                    A(g, b);
                    var m = f,
                        n = m.buffer,
                        q = void 0,
                    ...
                    if (t instanceof THREE.MeshFaceMaterial) q =
                        n.materialIndex, q = t.materials[q], q.transparent ? (m.transparent = q, m.opaque = null) : (m.opaque = q, m.transparent = null);
                    else if (q = t) q.transparent ? (m.transparent = q, m.opaque = null) : (m.opaque = q, m.transparent = null);
                    f.render = !0;
                    !0 === this.sortObjects && (null !== g.renderDepth ? f.z = g.renderDepth : (Ib.copy(g.matrixWorld.getPosition()), kc.multiplyVector3(Ib), f.z = Ib.z), f.id = g.id)
                } this.sortObjects && h.sort(p);
            h = a.__webglObjectsImmediate;
            d = 0;
            for (e = h.length; d < e; d++) f = h[d], g = f.object, g.visible && (A(g, b), g = f.object.material, g.transparent ?
            ...
            a.overrideMaterial ? (d = a.overrideMaterial, this.setBlending(d.blending, d.blendEquation, d.blendSrc, d.blendDst), this.setDepthTest(d.depthTest), this.setDepthWrite(d.depthWrite), G(d.polygonOffset, d.polygonOffsetFactor, d.polygonOffsetUnits), s(a.__webglObjects, !1, "", b, i, k, !0, d), l(a.__webglObjectsImmediate, "", b, i, k, !1, d)) : (d = null, this.setBlending(THREE.NoBlending), s(a.__webglObjects, !0, "opaque", b, i, k, !1, d), l(a.__webglObjectsImmediate, "opaque",
                b, i, k, !1, d), s(a.__webglObjects, !1, "transparent", b, i, k, !0, d), l(a.__webglObjectsImmediate, "transparent", b, i, k, !0, d));
    ...
    this.renderImmediateObject = function (a, b, c, d, e) {
        ...
        e.immediateRenderCallback ? e.immediateRenderCallback(f, j, yb) : e.render(function (a) {
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsAdded.length;) {
            var b = a.__objectsAdded[0],
                ...
                r = void 0;
            if (!b.__webglInit)
                if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, void 0 !== b.geometry && void 0 === b.geometry.__webglInit && (b.geometry.__webglInit = !0, b.geometry.addEventListener("dispose", $a)), b instanceof THREE.Mesh)
                    if (l = b.geometry, p = b.material, l instanceof THREE.Geometry) {
                        if (void 0 === l.geometryGroups) {
                            ...
                            s.geometryGroups = {};
                            y = 0;
                            for (z = s.faces.length; y < z; y++) A = s.faces[y], C = I ? A.materialIndex : 0, void 0 === G[C] && (G[C] = {
                                hash: C,
                                counter: 0
                            }), F = G[C].hash + "_" + G[C].counter, void 0 === s.geometryGroups[F] && (s.geometryGroups[F] = {
                                faces3: [],
                                faces4: [],
                                materialIndex: C,
                                vertices: 0,
                                numMorphTargets: O,
                                numMorphNormals: H
                            }), D = A instanceof THREE.Face3 ? 3 : 4, 65535 < s.geometryGroups[F].vertices + D && (G[C].counter += 1, F = G[C].hash + "_" + G[C].counter, void 0 === s.geometryGroups[F] && (s.geometryGroups[F] = {
                                faces3: [],
                                faces4: [],
                                materialIndex: C,
                                vertices: 0,
                                numMorphTargets: O,
                                numMorphNormals: H
                            })), A instanceof THREE.Face3 ? s.geometryGroups[F].faces3.push(y) : s.geometryGroups[F].faces4.push(y), s.geometryGroups[F].vertices += D;
                            s.geometryGroupsList = [];
                            var K = void 0;
                            for (K in s.geometryGroups) s.geometryGroups[K].id = oa++, s.geometryGroupsList.push(s.geometryGroups[K])
                        }
                        for (n in l.geometryGroups)
                            if (r = l.geometryGroups[n], !r.__webglVertexBuffer) {
                                ...
                                if (J.numMorphTargets) {
                                    ...
                                    L = 0;
                                    for (V = J.numMorphTargets; L < V; L++) J.__webglMorphTargetsBuffers.push(j.createBuffer())
                                }
                                if (J.numMorphNormals) {
                                    J.__webglMorphNormalsBuffers = [];
                                    L = 0;
                                    for (V = J.numMorphNormals; L < V; L++) J.__webglMorphNormalsBuffers.push(j.createBuffer())
                                }
                                N.info.memory.geometries++;
                                d(r, b);
                ...
                if (l = b.geometry, !l.__webglVertexBuffer) {
                    ...
                    aa.__vertexArray = new Float32Array(3 *
                        fa);
            ...
            } else if (b instanceof THREE.ParticleSystem && (l = b.geometry, !l.__webglVertexBuffer))
                if (l instanceof THREE.Geometry) {
                    ...
                    ja.__colorArray = new Float32Array(3 *
                        ka);
                    ja.__sortArray = [];
            ...
            if (!b.__webglActive) {
                if (b instanceof THREE.Mesh)
                    if (l = b.geometry, l instanceof THREE.BufferGeometry) q(k.__webglObjects, l, b);
                    else
                        for (n in l.geometryGroups) r = l.geometryGroups[n], q(k.__webglObjects, r, b);
                else b instanceof THREE.Ribbon || b instanceof THREE.Line || b instanceof THREE.ParticleSystem ? (l = b.geometry, q(k.__webglObjects, l, b)) : b instanceof THREE.ImmediateRenderObject ||
                    b.immediateRenderCallback ? k.__webglObjectsImmediate.push({
                        object: b,
                        opaque: null,
                        transparent: null
        ...
        for (; a.__objectsRemoved.length;) {
            var ca = a.__objectsRemoved[0],
                pa = a;
            ca instanceof THREE.Mesh || ca instanceof THREE.ParticleSystem || ca instanceof THREE.Ribbon || ca instanceof THREE.Line ? x(pa.__webglObjects, ca) : ca instanceof THREE.Sprite ? t(pa.__webglSprites,
                ca) : ca instanceof THREE.LensFlare ? t(pa.__webglFlares, ca) : (ca instanceof THREE.ImmediateRenderObject || ca.immediateRenderCallback) && x(pa.__webglObjectsImmediate, ca);
            ca.__webglActive = !1;
        ...
        for (var sa = 0, ya = a.__webglObjects.length; sa < ya; sa++) {
            ...
            if (za instanceof THREE.Mesh)
                if (W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate || W.elementsNeedUpdate || W.uvsNeedUpdate || W.normalsNeedUpdate || W.colorsNeedUpdate ||
                    W.tangentsNeedUpdate) && i(W, j.DYNAMIC_DRAW, !W.dynamic), W.verticesNeedUpdate = !1, W.elementsNeedUpdate = !1, W.uvsNeedUpdate = !1, W.normalsNeedUpdate = !1, W.colorsNeedUpdate = !1, W.tangentsNeedUpdate = !1;
                else {
                    for (var Ea = 0, Oa = W.geometryGroupsList.length; Ea < Oa; Ea++)
                        if (xa = W.geometryGroupsList[Ea], ma = e(za, xa), W.buffersNeedUpdate && d(xa, za), Da = ma.attributes && u(ma), W.verticesNeedUpdate || W.morphTargetsNeedUpdate || W.elementsNeedUpdate || W.uvsNeedUpdate || W.normalsNeedUpdate || W.colorsNeedUpdate || W.tangentsNeedUpdate || Da) {
                            var ta =
                                xa,
                                Ta = za,
                                ua = j.DYNAMIC_DRAW,
                            ...
                            if (ta.__inittedArrays) {
                                ...
                                if (ub.verticesNeedUpdate) {
                                    E = 0;
                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], S = sc[Q.a], T = sc[Q.b], U = sc[Q.c], cb[Sa] = S.x, cb[Sa + 1] = S.y, cb[Sa + 2] = S.z, cb[Sa + 3] = T.x, cb[Sa + 4] = T.y, cb[Sa + 5] = T.z, cb[Sa + 6] = U.x, cb[Sa + 7] = U.y, cb[Sa + 8] =
                                        U.z, Sa += 9;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], S = sc[Q.a], T = sc[Q.b], U = sc[Q.c], ra = sc[Q.d], cb[Sa] = S.x, cb[Sa + 1] = S.y, cb[Sa + 2] = S.z, cb[Sa + 3] = T.x, cb[Sa + 4] = T.y, cb[Sa + 5] = T.z, cb[Sa + 6] = U.x, cb[Sa + 7] = U.y, cb[Sa + 8] = U.z, cb[Sa + 9] = ra.x, cb[Sa + 10] = ra.y, cb[Sa + 11] = ra.z, Sa += 12;
                                ...
                                if (cd) {
                                    ...
                                    for (jc = oc.length; bb < jc; bb++) {
                                        E = na = 0;
                                        for (Y = va.length; E < Y; E++) mc = va[E], Q = mb[mc], S = oc[bb].vertices[Q.a], T = oc[bb].vertices[Q.b], U = oc[bb].vertices[Q.c],
                                        ...
                                        E = 0;
                                        for (Y = wa.length; E < Y; E++) mc = wa[E], Q = mb[mc], S = oc[bb].vertices[Q.a], T = oc[bb].vertices[Q.b], U = oc[bb].vertices[Q.c], ra = oc[bb].vertices[Q.d],
                                        ...
                                        Ha.morphNormals && (j.bindBuffer(j.ARRAY_BUFFER, ta.__webglMorphNormalsBuffers[bb]), j.bufferData(j.ARRAY_BUFFER, rc[bb], ua))
                                    }
                                }
                                if (nc.length) {
                                    E = 0;
                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], Tb = nc[Q.a], Ub = nc[Q.b], Vb = nc[Q.c], Ma[ea] = Tb.x, Ma[ea + 1] = Tb.y, Ma[ea + 2] = Tb.z, Ma[ea + 3] = Tb.w, Ma[ea + 4] = Ub.x, Ma[ea + 5] = Ub.y, Ma[ea + 6] = Ub.z, Ma[ea + 7] = Ub.w, Ma[ea + 8] = Vb.x, Ma[ea + 9] = Vb.y, Ma[ea + 10] = Vb.z, Ma[ea + 11] = Vb.w, Wb = tc[Q.a], Xb = tc[Q.b], Yb = tc[Q.c], La[ea] = Wb.x, La[ea +
                                        1] = Wb.y, La[ea + 2] = Wb.z, La[ea + 3] = Wb.w, La[ea + 4] = Xb.x, La[ea + 5] = Xb.y, La[ea + 6] = Xb.z, La[ea + 7] = Xb.w, La[ea + 8] = Yb.x, La[ea + 9] = Yb.y, La[ea + 10] = Yb.z, La[ea + 11] = Yb.w, ea += 12;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], Tb = nc[Q.a], Ub = nc[Q.b], Vb = nc[Q.c], Cb = nc[Q.d], Ma[ea] = Tb.x, Ma[ea + 1] = Tb.y, Ma[ea + 2] = Tb.z, Ma[ea + 3] = Tb.w, Ma[ea + 4] = Ub.x, Ma[ea + 5] = Ub.y, Ma[ea + 6] = Ub.z, Ma[ea + 7] = Ub.w, Ma[ea + 8] = Vb.x, Ma[ea + 9] = Vb.y, Ma[ea + 10] = Vb.z, Ma[ea + 11] = Vb.w, Ma[ea + 12] = Cb.x, Ma[ea + 13] = Cb.y, Ma[ea + 14] = Cb.z, Ma[ea + 15] = Cb.w, Wb = tc[Q.a], Xb = tc[Q.b], Yb = tc[Q.c],
                                        Db = tc[Q.d], La[ea] = Wb.x, La[ea + 1] = Wb.y, La[ea + 2] = Wb.z, La[ea + 3] = Wb.w, La[ea + 4] = Xb.x, La[ea + 5] = Xb.y, La[ea + 6] = Xb.z, La[ea + 7] = Xb.w, La[ea + 8] = Yb.x, La[ea + 9] = Yb.y, La[ea + 10] = Yb.z, La[ea + 11] = Yb.w, La[ea + 12] = Db.x, La[ea + 13] = Db.y, La[ea + 14] = Db.z, La[ea + 15] = Db.w, ea += 16;
                                    0 < ea && (j.bindBuffer(j.ARRAY_BUFFER, ta.__webglSkinIndicesBuffer), j.bufferData(j.ARRAY_BUFFER, La, ua), j.bindBuffer(j.ARRAY_BUFFER, ta.__webglSkinWeightsBuffer), j.bufferData(j.ARRAY_BUFFER, Ma, ua))
                                }
                                if (bd && nb) {
                                    E = 0;
                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], Ua = Q.vertexColors,
                                        Bb = Q.color, 3 === Ua.length && nb === THREE.VertexColors ? (Qb = Ua[0], Rb = Ua[1], Sb = Ua[2]) : Sb = Rb = Qb = Bb, db[Qa] = Qb.r, db[Qa + 1] = Qb.g, db[Qa + 2] = Qb.b, db[Qa + 3] = Rb.r, db[Qa + 4] = Rb.g, db[Qa + 5] = Rb.b, db[Qa + 6] = Sb.r, db[Qa + 7] = Sb.g, db[Qa + 8] = Sb.b, Qa += 9;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], Ua = Q.vertexColors, Bb = Q.color, 4 === Ua.length && nb === THREE.VertexColors ? (Qb = Ua[0], Rb = Ua[1], Sb = Ua[2], zb = Ua[3]) : zb = Sb = Rb = Qb = Bb, db[Qa] = Qb.r, db[Qa + 1] = Qb.g, db[Qa + 2] = Qb.b, db[Qa + 3] = Rb.r, db[Qa + 4] = Rb.g, db[Qa + 5] = Rb.b, db[Qa + 6] = Sb.r, db[Qa + 7] = Sb.g, db[Qa + 8] =
                                        Sb.b, db[Qa + 9] = zb.r, db[Qa + 10] = zb.g, db[Qa + 11] = zb.b, Qa += 12;
                                    0 < Qa && (j.bindBuffer(j.ARRAY_BUFFER, ta.__webglColorBuffer), j.bufferData(j.ARRAY_BUFFER, db, ua))
                                }
                                if (Lc && ub.hasTangents) {
                                    E = 0;
                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], eb = Q.vertexTangents, Za = eb[0], fb = eb[1], gb = eb[2], Ka[Fa] = Za.x, Ka[Fa + 1] = Za.y, Ka[Fa + 2] = Za.z, Ka[Fa + 3] = Za.w, Ka[Fa + 4] = fb.x, Ka[Fa + 5] = fb.y, Ka[Fa + 6] = fb.z, Ka[Fa + 7] = fb.w, Ka[Fa + 8] = gb.x, Ka[Fa + 9] = gb.y, Ka[Fa + 10] = gb.z, Ka[Fa + 11] = gb.w, Fa += 12;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], eb = Q.vertexTangents, Za = eb[0],
                                        fb = eb[1], gb = eb[2], tb = eb[3], Ka[Fa] = Za.x, Ka[Fa + 1] = Za.y, Ka[Fa + 2] = Za.z, Ka[Fa + 3] = Za.w, Ka[Fa + 4] = fb.x, Ka[Fa + 5] = fb.y, Ka[Fa + 6] = fb.z, Ka[Fa + 7] = fb.w, Ka[Fa + 8] = gb.x, Ka[Fa + 9] = gb.y, Ka[Fa + 10] = gb.z, Ka[Fa + 11] = gb.w, Ka[Fa + 12] = tb.x, Ka[Fa + 13] = tb.y, Ka[Fa + 14] = tb.z, Ka[Fa + 15] = tb.w, Fa += 16;
                                ...
                                if (Kc && Va) {
                                    ...
                                    for (Y = va.length; E < Y; E++)
                                        if (Q = mb[va[E]], ab = Q.vertexNormals, kb = Q.normal, 3 === ab.length && hb)
                                            for (Aa = 0; 3 > Aa; Aa++) lc = ab[Aa], Fb[lb] = lc.x, Fb[lb + 1] =
                                                lc.y, Fb[lb + 2] = lc.z, lb += 3;
                                        else
                                            for (Aa = 0; 3 > Aa; Aa++) Fb[lb] = kb.x, Fb[lb + 1] = kb.y, Fb[lb + 2] = kb.z, lb += 3;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++)
                                        if (Q = mb[wa[E]], ab = Q.vertexNormals, kb = Q.normal, 4 === ab.length && hb)
                                            for (Aa = 0; 4 > Aa; Aa++) lc = ab[Aa], Fb[lb] = lc.x, Fb[lb + 1] = lc.y, Fb[lb + 2] = lc.z, lb += 3;
                                        else
                                            for (Aa = 0; 4 > Aa; Aa++) Fb[lb] = kb.x, Fb[lb + 1] = kb.y, Fb[lb + 2] = kb.z, lb += 3;
                                ...
                                if (Bc && gd && ob) {
                                    ...
                                    for (Y = va.length; E < Y; E++)
                                        if (Wa = va[E], pb = gd[Wa], void 0 !== pb)
                                            for (Aa =
                                                0; 3 > Aa; Aa++) wc = pb[Aa], Lb[fc] = wc.x, Lb[fc + 1] = wc.y, fc += 2;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++)
                                        if (Wa = wa[E], pb = gd[Wa], void 0 !== pb)
                                            for (Aa = 0; 4 > Aa; Aa++) wc = pb[Aa], Lb[fc] = wc.x, Lb[fc + 1] = wc.y, fc += 2;
                                    0 < fc && (j.bindBuffer(j.ARRAY_BUFFER, ta.__webglUVBuffer), j.bufferData(j.ARRAY_BUFFER, Lb, ua))
                                }
                                if (Bc && hd && ob) {
                                    E = 0;
                                    for (Y = va.length; E < Y; E++)
                                        if (Wa = va[E], qb = hd[Wa], void 0 !== qb)
                                            for (Aa = 0; 3 > Aa; Aa++) xc = qb[Aa], Mb[gc] = xc.x, Mb[gc + 1] = xc.y, gc += 2;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++)
                                        if (Wa = wa[E], qb = hd[Wa], void 0 !== qb)
                                            for (Aa = 0; 4 > Aa; Aa++) xc = qb[Aa], Mb[gc] =
                                                xc.x, Mb[gc + 1] = xc.y, gc += 2;
                                    0 < gc && (j.bindBuffer(j.ARRAY_BUFFER, ta.__webglUV2Buffer), j.bufferData(j.ARRAY_BUFFER, Mb, ua))
                                }
                                if (Jc) {
                                    E = 0;
                                    for (Y = va.length; E < Y; E++) Zb[Eb] = Pa, Zb[Eb + 1] = Pa + 1, Zb[Eb + 2] = Pa + 2, Eb += 3, Ab[rb] = Pa, Ab[rb + 1] = Pa + 1, Ab[rb + 2] = Pa, Ab[rb + 3] = Pa + 2, Ab[rb + 4] = Pa + 1, Ab[rb + 5] = Pa + 2, rb += 6, Pa += 3;
                                    E = 0;
                                    for (Y = wa.length; E < Y; E++) Zb[Eb] = Pa, Zb[Eb + 1] = Pa + 1, Zb[Eb + 2] = Pa + 3, Zb[Eb + 3] = Pa + 1, Zb[Eb + 4] = Pa + 2, Zb[Eb + 5] = Pa + 3, Eb += 6, Ab[rb] = Pa, Ab[rb + 1] = Pa + 1, Ab[rb + 2] = Pa, Ab[rb + 3] = Pa + 3, Ab[rb + 4] = Pa + 1, Ab[rb + 5] = Pa + 2, Ab[rb + 6] = Pa + 2, Ab[rb + 7] =
                                        Pa + 3, rb += 8, Pa += 4;
                                        ...
                                        if (v = fd[Aa], v.__original.needsUpdate) {
                                            ...
                                            if (1 === v.size)
                                                if (void 0 === v.boundTo || "vertices" === v.boundTo) {
                                                    E = 0;
                                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], v.array[w] = v.value[Q.a], v.array[w + 1] = v.value[Q.b], v.array[w + 2] = v.value[Q.c], w += 3;
                                                    E = 0;
                                                    for (Y = wa.length; E <
                                                        Y; E++) Q = mb[wa[E]], v.array[w] = v.value[Q.a], v.array[w + 1] = v.value[Q.b], v.array[w + 2] = v.value[Q.c], v.array[w + 3] = v.value[Q.d], w += 4
                                                } else {
                                                    if ("faces" === v.boundTo) {
                                                        E = 0;
                                                        for (Y = va.length; E < Y; E++) Ba = v.value[va[E]], v.array[w] = Ba, v.array[w + 1] = Ba, v.array[w + 2] = Ba, w += 3;
                                                        E = 0;
                                                        for (Y = wa.length; E < Y; E++) Ba = v.value[wa[E]], v.array[w] = Ba, v.array[w + 1] = Ba, v.array[w + 2] = Ba, v.array[w + 3] = Ba, w += 4
                                                    }
                                                }
                                            else if (2 === v.size)
                                                if (void 0 === v.boundTo || "vertices" === v.boundTo) {
                                                    E = 0;
                                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], S = v.value[Q.a], T = v.value[Q.b],
                                                        U = v.value[Q.c], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = T.x, v.array[w + 3] = T.y, v.array[w + 4] = U.x, v.array[w + 5] = U.y, w += 6;
                                                    E = 0;
                                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], S = v.value[Q.a], T = v.value[Q.b], U = v.value[Q.c], ra = v.value[Q.d], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = T.x, v.array[w + 3] = T.y, v.array[w + 4] = U.x, v.array[w + 5] = U.y, v.array[w + 6] = ra.x, v.array[w + 7] = ra.y, w += 8
                                                } else {
                                                    if ("faces" === v.boundTo) {
                                                        E = 0;
                                                        for (Y = va.length; E < Y; E++) U = T = S = Ba = v.value[va[E]], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = T.x, v.array[w +
                                                            3] = T.y, v.array[w + 4] = U.x, v.array[w + 5] = U.y, w += 6;
                                                        E = 0;
                                                        for (Y = wa.length; E < Y; E++) ra = U = T = S = Ba = v.value[wa[E]], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = T.x, v.array[w + 3] = T.y, v.array[w + 4] = U.x, v.array[w + 5] = U.y, v.array[w + 6] = ra.x, v.array[w + 7] = ra.y, w += 8
                                                    }
                                                }
                                            else if (3 === v.size) {
                                                var ba;
                                                ...
                                                if (void 0 === v.boundTo || "vertices" === v.boundTo) {
                                                    E = 0;
                                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], S = v.value[Q.a], T = v.value[Q.b], U = v.value[Q.c], v.array[w] = S[ba[0]], v.array[w + 1] = S[ba[1]], v.array[w + 2] =
                                                        S[ba[2]], v.array[w + 3] = T[ba[0]], v.array[w + 4] = T[ba[1]], v.array[w + 5] = T[ba[2]], v.array[w + 6] = U[ba[0]], v.array[w + 7] = U[ba[1]], v.array[w + 8] = U[ba[2]], w += 9;
                                                    E = 0;
                                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], S = v.value[Q.a], T = v.value[Q.b], U = v.value[Q.c], ra = v.value[Q.d], v.array[w] = S[ba[0]], v.array[w + 1] = S[ba[1]], v.array[w + 2] = S[ba[2]], v.array[w + 3] = T[ba[0]], v.array[w + 4] = T[ba[1]], v.array[w + 5] = T[ba[2]], v.array[w + 6] = U[ba[0]], v.array[w + 7] = U[ba[1]], v.array[w + 8] = U[ba[2]], v.array[w + 9] = ra[ba[0]], v.array[w + 10] = ra[ba[1]], v.array[w + 11] =
                                                        ra[ba[2]], w += 12
                                                } else if ("faces" === v.boundTo) {
                                                    E = 0;
                                                    for (Y = va.length; E < Y; E++) U = T = S = Ba = v.value[va[E]], v.array[w] = S[ba[0]], v.array[w + 1] = S[ba[1]], v.array[w + 2] = S[ba[2]], v.array[w + 3] = T[ba[0]], v.array[w + 4] = T[ba[1]], v.array[w + 5] = T[ba[2]], v.array[w + 6] = U[ba[0]], v.array[w + 7] = U[ba[1]], v.array[w + 8] = U[ba[2]], w += 9;
                                                    E = 0;
                                                    for (Y = wa.length; E < Y; E++) ra = U = T = S = Ba = v.value[wa[E]], v.array[w] = S[ba[0]], v.array[w + 1] = S[ba[1]], v.array[w + 2] = S[ba[2]], v.array[w + 3] = T[ba[0]], v.array[w + 4] = T[ba[1]], v.array[w + 5] = T[ba[2]], v.array[w + 6] = U[ba[0]],
                                                        v.array[w + 7] = U[ba[1]], v.array[w + 8] = U[ba[2]], v.array[w + 9] = ra[ba[0]], v.array[w + 10] = ra[ba[1]], v.array[w + 11] = ra[ba[2]], w += 12
                                                } else if ("faceVertices" === v.boundTo) {
                                                    E = 0;
                                                    for (Y = va.length; E < Y; E++) Ba = v.value[va[E]], S = Ba[0], T = Ba[1], U = Ba[2], v.array[w] = S[ba[0]], v.array[w + 1] = S[ba[1]], v.array[w + 2] = S[ba[2]], v.array[w + 3] = T[ba[0]], v.array[w + 4] = T[ba[1]], v.array[w + 5] = T[ba[2]], v.array[w + 6] = U[ba[0]], v.array[w + 7] = U[ba[1]], v.array[w + 8] = U[ba[2]], w += 9;
                                                    E = 0;
                                                    for (Y = wa.length; E < Y; E++) Ba = v.value[wa[E]], S = Ba[0], T = Ba[1], U = Ba[2], ra =
                                                        Ba[3], v.array[w] = S[ba[0]], v.array[w + 1] = S[ba[1]], v.array[w + 2] = S[ba[2]], v.array[w + 3] = T[ba[0]], v.array[w + 4] = T[ba[1]], v.array[w + 5] = T[ba[2]], v.array[w + 6] = U[ba[0]], v.array[w + 7] = U[ba[1]], v.array[w + 8] = U[ba[2]], v.array[w + 9] = ra[ba[0]], v.array[w + 10] = ra[ba[1]], v.array[w + 11] = ra[ba[2]], w += 12
                                                }
                                            } else if (4 === v.size)
                                                if (void 0 === v.boundTo || "vertices" === v.boundTo) {
                                                    E = 0;
                                                    for (Y = va.length; E < Y; E++) Q = mb[va[E]], S = v.value[Q.a], T = v.value[Q.b], U = v.value[Q.c], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = S.z, v.array[w + 3] = S.w, v.array[w +
                                                        4] = T.x, v.array[w + 5] = T.y, v.array[w + 6] = T.z, v.array[w + 7] = T.w, v.array[w + 8] = U.x, v.array[w + 9] = U.y, v.array[w + 10] = U.z, v.array[w + 11] = U.w, w += 12;
                                                    E = 0;
                                                    for (Y = wa.length; E < Y; E++) Q = mb[wa[E]], S = v.value[Q.a], T = v.value[Q.b], U = v.value[Q.c], ra = v.value[Q.d], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = S.z, v.array[w + 3] = S.w, v.array[w + 4] = T.x, v.array[w + 5] = T.y, v.array[w + 6] = T.z, v.array[w + 7] = T.w, v.array[w + 8] = U.x, v.array[w + 9] = U.y, v.array[w + 10] = U.z, v.array[w + 11] = U.w, v.array[w + 12] = ra.x, v.array[w + 13] = ra.y, v.array[w + 14] = ra.z, v.array[w +
                                                        15] = ra.w, w += 16
                                                } else if ("faces" === v.boundTo) {
                                                E = 0;
                                                for (Y = va.length; E < Y; E++) U = T = S = Ba = v.value[va[E]], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = S.z, v.array[w + 3] = S.w, v.array[w + 4] = T.x, v.array[w + 5] = T.y, v.array[w + 6] = T.z, v.array[w + 7] = T.w, v.array[w + 8] = U.x, v.array[w + 9] = U.y, v.array[w + 10] = U.z, v.array[w + 11] = U.w, w += 12;
                                                E = 0;
                                                for (Y = wa.length; E < Y; E++) ra = U = T = S = Ba = v.value[wa[E]], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = S.z, v.array[w + 3] = S.w, v.array[w + 4] = T.x, v.array[w + 5] = T.y, v.array[w + 6] = T.z, v.array[w + 7] = T.w, v.array[w +
                                                    8] = U.x, v.array[w + 9] = U.y, v.array[w + 10] = U.z, v.array[w + 11] = U.w, v.array[w + 12] = ra.x, v.array[w + 13] = ra.y, v.array[w + 14] = ra.z, v.array[w + 15] = ra.w, w += 16
                                            } else if ("faceVertices" === v.boundTo) {
                                                E = 0;
                                                for (Y = va.length; E < Y; E++) Ba = v.value[va[E]], S = Ba[0], T = Ba[1], U = Ba[2], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = S.z, v.array[w + 3] = S.w, v.array[w + 4] = T.x, v.array[w + 5] = T.y, v.array[w + 6] = T.z, v.array[w + 7] = T.w, v.array[w + 8] = U.x, v.array[w + 9] = U.y, v.array[w + 10] = U.z, v.array[w + 11] = U.w, w += 12;
                                                E = 0;
                                                for (Y = wa.length; E < Y; E++) Ba = v.value[wa[E]],
                                                    S = Ba[0], T = Ba[1], U = Ba[2], ra = Ba[3], v.array[w] = S.x, v.array[w + 1] = S.y, v.array[w + 2] = S.z, v.array[w + 3] = S.w, v.array[w + 4] = T.x, v.array[w + 5] = T.y, v.array[w + 6] = T.z, v.array[w + 7] = T.w, v.array[w + 8] = U.x, v.array[w + 9] = U.y, v.array[w + 10] = U.z, v.array[w + 11] = U.w, v.array[w + 12] = ra.x, v.array[w + 13] = ra.y, v.array[w + 14] = ra.z, v.array[w + 15] = ra.w, w += 16
                                            }
                                            j.bindBuffer(j.ARRAY_BUFFER, v.buffer);
                                            j.bufferData(j.ARRAY_BUFFER, v.array, ua)
                                        }
                                }
                                Ra && (delete ta.__inittedArrays, delete ta.__colorArray, delete ta.__normalArray, delete ta.__tangentArray,
                                    delete ta.__uvArray, delete ta.__uv2Array, delete ta.__faceArray, delete ta.__vertexArray, delete ta.__lineArray, delete ta.__skinIndexArray, delete ta.__skinWeightArray)
                            }
                ...
                if (W.verticesNeedUpdate || W.colorsNeedUpdate || W.normalsNeedUpdate ||
                    Da) {
                    var Gb = W,
                        Nc = j.DYNAMIC_DRAW,
                        Cc = void 0,
                    ...
                    if (Gb.verticesNeedUpdate) {
                        for (Cc = 0; Cc < dd; Cc++) Oc = od[Cc], Ca = 3 * Cc, Sc[Ca] = Oc.x, Sc[Ca + 1] = Oc.y, Sc[Ca + 2] = Oc.z;
                        j.bindBuffer(j.ARRAY_BUFFER,
                            Gb.__webglVertexBuffer);
                        j.bufferData(j.ARRAY_BUFFER, Sc, Nc)
                    }
                    if (Bd) {
                        for (Dc = 0; Dc < zd; Dc++) Pc = pd[Dc], Ca = 3 * Dc, Tc[Ca] = Pc.r, Tc[Ca + 1] = Pc.g, Tc[Ca + 2] = Pc.b;
                        j.bindBuffer(j.ARRAY_BUFFER, Gb.__webglColorBuffer);
                        j.bufferData(j.ARRAY_BUFFER, Tc, Nc)
                    }
                    if (Cd) {
                        for (Ec = 0; Ec < Ad; Ec++) Qc = qd[Ec], Ca = 3 * Ec, Uc[Ca] = Qc.x, Uc[Ca + 1] = Qc.y, Uc[Ca + 2] = Qc.z;
                    ...
                    if (id) {
                        ...
                        for (nd = id.length; Rc < nd; Rc++)
                            if (Ia = id[Rc], Ia.needsUpdate && (void 0 === Ia.boundTo || "vertices" ===
                                    Ia.boundTo)) {
                                Ca = 0;
                                yc = Ia.value.length;
                                if (1 === Ia.size)
                                    ...
                                    for (ib = 0; ib < yc; ib++) vb = Ia.value[ib], Ia.array[Ca] = vb.x, Ia.array[Ca + 1] = vb.y, Ca += 2;
                                else if (3 === Ia.size)
                                    if ("c" === Ia.type)
                                        for (ib = 0; ib < yc; ib++) vb = Ia.value[ib], Ia.array[Ca] = vb.r, Ia.array[Ca + 1] = vb.g, Ia.array[Ca + 2] = vb.b, Ca += 3;
                                    else
                                        for (ib = 0; ib < yc; ib++) vb = Ia.value[ib], Ia.array[Ca] = vb.x, Ia.array[Ca + 1] = vb.y, Ia.array[Ca + 2] = vb.z, Ca += 3;
                                else if (4 === Ia.size)
                                    for (ib = 0; ib < yc; ib++) vb = Ia.value[ib], Ia.array[Ca] =
                                        vb.x, Ia.array[Ca + 1] = vb.y, Ia.array[Ca + 2] = vb.z, Ia.array[Ca + 3] = vb.w, Ca += 4;
                ...
                ma = e(za, W);
                Da = ma.attributes && u(ma);
                if (W.verticesNeedUpdate || W.colorsNeedUpdate || W.lineDistancesNeedUpdate || Da) {
                    var Hb = W,
                        Vc = j.DYNAMIC_DRAW,
                        Fc = void 0,
                        Gc = void 0,
                    ...
                    if (Hb.verticesNeedUpdate) {
                        for (Fc = 0; Fc < Dd; Fc++) Wc = rd[Fc], Na = 3 * Fc, Yc[Na] = Wc.x, Yc[Na + 1] = Wc.y, Yc[Na + 2] = Wc.z;
                        j.bindBuffer(j.ARRAY_BUFFER, Hb.__webglVertexBuffer);
                        j.bufferData(j.ARRAY_BUFFER, Yc, Vc)
                    }
                    if (Gd) {
                        for (Gc = 0; Gc < Ed; Gc++) Xc = sd[Gc], Na =
                            3 * Gc, Zc[Na] = Xc.r, Zc[Na + 1] = Xc.g, Zc[Na + 2] = Xc.b;
                    ...
                    if (jd) {
                        ...
                        for (vd = jd.length; $c < vd; $c++)
                            if (Ja = jd[$c], Ja.needsUpdate && (void 0 === Ja.boundTo || "vertices" === Ja.boundTo)) {
                                Na = 0;
                                zc = Ja.value.length;
                                if (1 === Ja.size)
                                    for (jb = 0; jb < zc; jb++) Ja.array[jb] = Ja.value[jb];
                                else if (2 === Ja.size)
                                    for (jb = 0; jb < zc; jb++) wb =
                                        Ja.value[jb], Ja.array[Na] = wb.x, Ja.array[Na + 1] = wb.y, Na += 2;
                                else if (3 === Ja.size)
                                    if ("c" === Ja.type)
                                        for (jb = 0; jb < zc; jb++) wb = Ja.value[jb], Ja.array[Na] = wb.r, Ja.array[Na + 1] = wb.g, Ja.array[Na + 2] = wb.b, Na += 3;
                                    else
                                        for (jb = 0; jb < zc; jb++) wb = Ja.value[jb], Ja.array[Na] = wb.x, Ja.array[Na + 1] = wb.y, Ja.array[Na + 2] = wb.z, Na += 3;
                                else if (4 === Ja.size)
                                    for (jb = 0; jb < zc; jb++) wb = Ja.value[jb], Ja.array[Na] = wb.x, Ja.array[Na + 1] = wb.y, Ja.array[Na + 2] = wb.z, Ja.array[Na + 3] = wb.w, Na += 4;
                ...
                if (W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate || W.colorsNeedUpdate) && i(W, j.DYNAMIC_DRAW, !W.dynamic), W.verticesNeedUpdate = !1, W.colorsNeedUpdate = !1;
                else {
                    ma = e(za, W);
                    Da = ma.attributes && u(ma);
                    if (W.verticesNeedUpdate || W.colorsNeedUpdate || za.sortParticles || Da) {
                        var $b = W,
                            kd = j.DYNAMIC_DRAW,
                            Ic = za,
                            xb = void 0,
                        ...
                        if (Ic.sortParticles) {
                            ...
                            for (xb = 0; xb < ld; xb++) bc = ad[xb], Ib.copy(bc), sb.multiplyVector3(Ib), hc[xb] = [Ib.z, xb];
                            hc.sort(m);
                            for (xb = 0; xb < ld; xb++) bc = ad[hc[xb][1]], ia = 3 * xb, uc[ia] = bc.x, uc[ia + 1] = bc.y, uc[ia + 2] =
                                bc.z;
                            for (ac = 0; ac < wd; ac++) ia = 3 * ac, pc = md[hc[ac][1]], vc[ia] = pc.r, vc[ia + 1] = pc.g, vc[ia + 2] = pc.b;
                            if (ic) {
                                Jb = 0;
                                for (Ac = ic.length; Jb < Ac; Jb++)
                                    if (ha = ic[Jb], void 0 === ha.boundTo || "vertices" === ha.boundTo)
                                        if (ia = 0, Kb = ha.value.length, 1 === ha.size)
                                            for (qa = 0; qa < Kb; qa++) cc = hc[qa][1], ha.array[qa] = ha.value[cc];
                                        else if (2 === ha.size)
                                    for (qa = 0; qa < Kb; qa++) cc = hc[qa][1], Ga = ha.value[cc], ha.array[ia] = Ga.x, ha.array[ia + 1] = Ga.y, ia += 2;
                                else if (3 === ha.size)
                                    if ("c" === ha.type)
                                        for (qa = 0; qa < Kb; qa++) cc = hc[qa][1], Ga = ha.value[cc], ha.array[ia] = Ga.r,
                                            ha.array[ia + 1] = Ga.g, ha.array[ia + 2] = Ga.b, ia += 3;
                                    else
                                        for (qa = 0; qa < Kb; qa++) cc = hc[qa][1], Ga = ha.value[cc], ha.array[ia] = Ga.x, ha.array[ia + 1] = Ga.y, ha.array[ia + 2] = Ga.z, ia += 3;
                                else if (4 === ha.size)
                                    for (qa = 0; qa < Kb; qa++) cc = hc[qa][1], Ga = ha.value[cc], ha.array[ia] = Ga.x, ha.array[ia + 1] = Ga.y, ha.array[ia + 2] = Ga.z, ha.array[ia + 3] = Ga.w, ia += 4
                            }
                        } else {
                            if (xd)
                                for (xb = 0; xb < ld; xb++) bc = ad[xb], ia = 3 * xb, uc[ia] = bc.x, uc[ia + 1] = bc.y, uc[ia + 2] = bc.z;
                            if (yd)
                                for (ac = 0; ac < wd; ac++) pc = md[ac], ia = 3 * ac, vc[ia] = pc.r, vc[ia + 1] = pc.g, vc[ia + 2] = pc.b;
                            if (ic) {
                                Jb =
                                    0;
                                for (Ac = ic.length; Jb < Ac; Jb++)
                                    if (ha = ic[Jb], ha.needsUpdate && (void 0 === ha.boundTo || "vertices" === ha.boundTo))
                                        if (Kb = ha.value.length, ia = 0, 1 === ha.size)
                                            for (qa = 0; qa < Kb; qa++) ha.array[qa] = ha.value[qa];
                                        else if (2 === ha.size)
                                    for (qa = 0; qa < Kb; qa++) Ga = ha.value[qa], ha.array[ia] = Ga.x, ha.array[ia + 1] = Ga.y, ia += 2;
                                else if (3 === ha.size)
                                    if ("c" === ha.type)
                                        for (qa = 0; qa < Kb; qa++) Ga = ha.value[qa], ha.array[ia] = Ga.r, ha.array[ia + 1] = Ga.g, ha.array[ia + 2] = Ga.b, ia += 3;
                                    else
                                        for (qa = 0; qa < Kb; qa++) Ga = ha.value[qa], ha.array[ia] = Ga.x, ha.array[ia + 1] =
                                            Ga.y, ha.array[ia + 2] = Ga.z, ia += 3;
                                else if (4 === ha.size)
                                    for (qa = 0; qa < Kb; qa++) Ga = ha.value[qa], ha.array[ia] = Ga.x, ha.array[ia + 1] = Ga.y, ha.array[ia + 2] = Ga.z, ha.array[ia + 3] = Ga.w, ia += 4
                            }
                        }
                        if (xd || Ic.sortParticles) j.bindBuffer(j.ARRAY_BUFFER, $b.__webglVertexBuffer), j.bufferData(j.ARRAY_BUFFER, uc, kd);
                        if (yd || Ic.sortParticles) j.bindBuffer(j.ARRAY_BUFFER, $b.__webglColorBuffer), j.bufferData(j.ARRAY_BUFFER, vc, kd);
                        if (ic) {
                            Jb = 0;
                            for (Ac = ic.length; Jb < Ac; Jb++)
                                if (ha = ic[Jb], ha.needsUpdate || Ic.sortParticles) j.bindBuffer(j.ARRAY_BUFFER,
                                    ha.buffer), j.bufferData(j.ARRAY_BUFFER, ha.array, kd)
                        }
                    }
                    W.verticesNeedUpdate = !1;
                    W.colorsNeedUpdate = !1;
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        var i, k, m, n, l;
        a instanceof THREE.MeshDepthMaterial ? l = "depth" : a instanceof THREE.MeshNormalMaterial ? l = "normal" : a instanceof THREE.MeshBasicMaterial ? l = "basic" : a instanceof THREE.MeshLambertMaterial ? l = "lambert" : a instanceof THREE.MeshPhongMaterial ? l = "phong" : a instanceof THREE.LineBasicMaterial ? l = "basic" :
            a instanceof THREE.LineDashedMaterial ? l = "dashed" : a instanceof THREE.ParticleBasicMaterial && (l = "particle_basic");
        if (l) {
        ...
        var r, s, q;
        e = g = s = q = p = 0;
        for (f = b.length; e < f; e++) r = b[e], r.onlyShadow || (r instanceof THREE.DirectionalLight && g++, r instanceof THREE.PointLight && s++, r instanceof THREE.SpotLight && q++, r instanceof THREE.HemisphereLight && p++);
        e = g;
        f = s;
        g = q;
        h = p;
        p = r = 0;
        for (q =
            b.length; p < q; p++) s = b[p], s.castShadow && (s instanceof THREE.SpotLight && r++, s instanceof THREE.DirectionalLight && !s.shadowCascade && r++);
        n = r;
        gb && d && d.useVertexTexture ? m = 1024 : (b = j.getParameter(j.MAX_VERTEX_UNIFORM_VECTORS), b = Math.floor((b - 20) / 4), void 0 !== d && d instanceof THREE.SkinnedMesh && (b = Math.min(d.bones.length, b), b < d.bones.length && console.warn("WebGLRenderer: too many bones - " + d.bones.length + ", this GPU supports just " + b + " (try OpenGL instead of ANGLE)")), m = b);
        a: {
            s = a.fragmentShader;q = a.vertexShader;
            p = a.uniforms;b = a.attributes;r = a.defines;
            var c = {
                    map: !!a.map,
                    envMap: !!a.envMap,
                    lightMap: !!a.lightMap,
                ...
                t, u, x, d = [];l ? d.push(l) : (d.push(s), d.push(q));
            for (u in r) d.push(u),
            d.push(r[u]);
            for (t in c) d.push(t),
            ...
            for (u = O.length; t < u; t++)
                if (d = O[t], d.code === l) {
                    ...
                    k = d.program;
                    break a
                } t = "SHADOWMAP_TYPE_BASIC";c.shadowMapType === THREE.PCFShadowMap ? t = "SHADOWMAP_TYPE_PCF" : c.shadowMapType === THREE.PCFSoftShadowMap && (t = "SHADOWMAP_TYPE_PCF_SOFT");u = [];
            for (x in r) d = r[x],
            !1 !== d && (d = "#define " + x + " " + d, u.push(d));d = u.join("\n");x = j.createProgram();u = ["precision " + R + " float;", d, rc ? "#define VERTEX_TEXTURES" : "", N.gammaInput ? "#define GAMMA_INPUT" : "", N.gammaOutput ? "#define GAMMA_OUTPUT" :
            ...
            t = ["precision " + R + " float;", c.bumpMap || c.normalMap ? "#extension GL_OES_standard_derivatives : enable" : "", d, "#define MAX_DIR_LIGHTS " + c.maxDirLights, "#define MAX_POINT_LIGHTS " + c.maxPointLights, "#define MAX_SPOT_LIGHTS " + c.maxSpotLights, "#define MAX_HEMI_LIGHTS " + c.maxHemiLights, "#define MAX_SHADOWS " + c.maxShadows, c.alphaTest ? "#define ALPHATEST " + c.alphaTest : "", N.gammaInput ? "#define GAMMA_INPUT" : "", N.gammaOutput ? "#define GAMMA_OUTPUT" : "", N.physicallyBasedShading ? "#define PHYSICALLY_BASED_SHADING" : "",
                ...
                j.getError() + "]");j.deleteShader(t);j.deleteShader(u);x.uniforms = {};x.attributes = {};
            ...
            x.attributes[t] = j.getAttribLocation(x, t);x.id = aa++;O.push({
                program: x,
                code: l,
                usedTimes: 1
            });N.info.memory.programs = O.length;k = x
        }
        a.program = k;
    ...
    this.setDepthTest = function (a) {
        eb !== a && (a ? j.enable(j.DEPTH_TEST) : j.disable(j.DEPTH_TEST), eb = a)
    };
    ...
    this.setBlending = function (a, b, c, d) {
        a !== sa && (a === THREE.NoBlending ? j.disable(j.BLEND) : a === THREE.AdditiveBlending ? (j.enable(j.BLEND), j.blendEquation(j.FUNC_ADD), j.blendFunc(j.SRC_ALPHA, j.ONE)) : a === THREE.SubtractiveBlending ? (j.enable(j.BLEND),
            j.blendEquation(j.FUNC_ADD), j.blendFunc(j.ZERO, j.ONE_MINUS_SRC_COLOR)) : a === THREE.MultiplyBlending ? (j.enable(j.BLEND), j.blendEquation(j.FUNC_ADD), j.blendFunc(j.ZERO, j.SRC_COLOR)) : a === THREE.CustomBlending ? j.enable(j.BLEND) : (j.enable(j.BLEND), j.blendEquationSeparate(j.FUNC_ADD, j.FUNC_ADD), j.blendFuncSeparate(j.SRC_ALPHA, j.ONE_MINUS_SRC_ALPHA, j.ONE, j.ONE_MINUS_SRC_ALPHA)), sa = a);
        if (a === THREE.CustomBlending) {
            if (b !== nb && (j.blendEquation(J(b)), nb = b), c !== Bb || d !== kb) j.blendFunc(J(c), J(d)), Bb = c, kb = d
        } else kb =
            Bb = nb = null
    };
    this.setTexture = function (a, b) {
        if (a.needsUpdate) {
            a.__webglInit || (a.__webglInit = !0, a.addEventListener("dispose", Wa), a.__webglTexture = j.createTexture(), N.info.memory.textures++);
    ...
    this.setRenderTarget = function (a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            } else a.__webglFramebuffer = j.createFramebuffer(), a.__webglRenderbuffer = a.shareDepthFrom ? a.shareDepthFrom.__webglRenderbuffer : j.createRenderbuffer(), j.bindTexture(j.TEXTURE_2D, a.__webglTexture), D(j.TEXTURE_2D, a, c), j.texImage2D(j.TEXTURE_2D, 0, d, a.width, a.height, 0, d, e, null), d = j.TEXTURE_2D, j.bindFramebuffer(j.FRAMEBUFFER, a.__webglFramebuffer),
        ...
        a ? (b = b ? a.__webglFramebuffer[a.activeCubeFace] : a.__webglFramebuffer, c = a.width, a = a.height, e = d = 0) : (b = null, c = Ha, a = qb, d = Ra, e = Cb);
        b !== V && (j.bindFramebuffer(j.FRAMEBUFFER, b), j.viewport(d, e, c, a), V = b);
        fb = c;
        Oa = a
    };
...
THREE.GeometryUtils = {
    merge: function (a, b) {
        ...
        for (m = k.length; p < m; p++) {
            var r = k[p],
                s, l, q = r.vertexNormals,
                u = r.vertexColors;
            r instanceof THREE.Face3 ?
                s = new THREE.Face3(r.a + e, r.b + e, r.c + e) : r instanceof THREE.Face4 && (s = new THREE.Face4(r.a + e, r.b + e, r.c + e, r.d + e));
            s.normal.copy(r.normal);
            d && d.multiplyVector3(s.normal);
            g = 0;
            for (h = q.length; g < h; g++) l = q[g].clone(), d && d.multiplyVector3(l), s.vertexNormals.push(l);
    ...
    randomPointsInGeometry: function (a, b) {
        ...
        var d, e, f = a.faces,
            ...
            k = [],
            n, p, m, r;
        for (e = 0; e < h; e++) d = f[e], d instanceof THREE.Face3 ? (n = g[d.a], p = g[d.b], m = g[d.c],
            d._area = THREE.GeometryUtils.triangleArea(n, p, m)) : d instanceof THREE.Face4 && (n = g[d.a], p = g[d.b], m = g[d.c], r = g[d.d], d._area1 = THREE.GeometryUtils.triangleArea(n, p, r), d._area2 = THREE.GeometryUtils.triangleArea(p, m, r), d._area = d._area1 + d._area2), i += d._area, k[e] = i;
        d = [];
    ...
    triangulateQuads: function (a) {
        ...
        for (c = a.faces.length; b < c; b++)
            if (d = a.faces[b], d instanceof THREE.Face4) {
                ...
                m.b = k;
                m.c = n;
                4 === d.vertexColors.length && (p.vertexColors[0] = d.vertexColors[0].clone(), p.vertexColors[1] = d.vertexColors[1].clone(), p.vertexColors[2] = d.vertexColors[3].clone(),
                    m.vertexColors[0] = d.vertexColors[1].clone(), m.vertexColors[1] = d.vertexColors[2].clone(), m.vertexColors[2] = d.vertexColors[3].clone());
                f.push(p, m);
                d = 0;
                for (e = a.faceVertexUvs.length; d < e; d++) a.faceVertexUvs[d].length && (p = a.faceVertexUvs[d][b], i = p[1], k = p[2], n = p[3], p = [p[0].clone(), i.clone(), n.clone()], i = [i.clone(), k.clone(), n.clone()], h[d].push(p, i));
                d = 0;
    ...
    tessellate: function (a, b) {
        var c, d, e, f, g, h, i, k, n, p, m, r, s, l, q, u, B, x, t, F = [],
            C = [];
        c = 0;
        ...
        for (d = a.faces.length; c < d; c++)
            if (e = a.faces[c], e instanceof THREE.Face3)
                if (f = e.a, g = e.b, h = e.c, k = a.vertices[f], n = a.vertices[g], p = a.vertices[h], r = k.distanceTo(n), s = n.distanceTo(p),
                    m = k.distanceTo(p), r > b || s > b || m > b) {
                    i = a.vertices.length;
                    x = e.clone();
                    t = e.clone();
                    r >= s && r >= m ? (k = k.clone(), k.lerpSelf(n, 0.5), x.a = f, x.b = i, x.c = h, t.a = i, t.b = g, t.c = h, 3 === e.vertexNormals.length && (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[1], 0.5), x.vertexNormals[1].copy(f), t.vertexNormals[0].copy(f)), 3 === e.vertexColors.length && (f = e.vertexColors[0].clone(), f.lerpSelf(e.vertexColors[1], 0.5), x.vertexColors[1].copy(f), t.vertexColors[0].copy(f)), e = 0) : s >= r && s >= m ? (k = n.clone(), k.lerpSelf(p, 0.5), x.a = f, x.b =
                    ...
                    a.vertices.push(k);
                    f = 0;
                    for (g = a.faceVertexUvs.length; f < g; f++) a.faceVertexUvs[f].length && (k = a.faceVertexUvs[f][c], t = k[0], h = k[1], x = k[2], 0 === e ?
                        (n = t.clone(), n.lerpSelf(h, 0.5), k = [t.clone(), n.clone(), x.clone()], h = [n.clone(), h.clone(), x.clone()]) : 1 === e ? (n = h.clone(), n.lerpSelf(x, 0.5), k = [t.clone(), h.clone(), n.clone()], h = [n.clone(), x.clone(), t.clone()]) : (n = t.clone(), n.lerpSelf(x, 0.5), k = [t.clone(), h.clone(), n.clone()], h = [n.clone(), h.clone(), x.clone()]), C[f].push(k, h))
                } else {
                    F.push(e);
                    f = 0;
            ...
            for (g = a.faceVertexUvs.length; f <
                g; f++) a.faceVertexUvs[f].length && (k = a.faceVertexUvs[f][c], t = k[0], h = k[1], x = k[2], k = k[3], 0 === e ? (n = t.clone(), n.lerpSelf(h, 0.5), p = x.clone(), p.lerpSelf(k, 0.5), t = [t.clone(), n.clone(), p.clone(), k.clone()], h = [n.clone(), h.clone(), x.clone(), p.clone()]) : (n = h.clone(), n.lerpSelf(x, 0.5), p = k.clone(), p.lerpSelf(t, 0.5), t = [t.clone(), h.clone(), n.clone(), p.clone()], h = [p.clone(), n.clone(), x.clone(), k.clone()]), C[f].push(t, h))
        } else {
            F.push(e);
            f = 0;
            for (g = a.faceVertexUvs.length; f < g; f++) C[f].push(a.faceVertexUvs[f][c])
...
THREE.ImageUtils = {
    ...
    getNormalMap: function (a, b) {
        ...
        for (var h = g.getImageData(0,
                0, d, e).data, i = g.createImageData(d, e), k = i.data, n = 0; n < d; n++)
            for (var p = 0; p < e; p++) {
                var m = 0 > p - 1 ? 0 : p - 1,
                    r = p + 1 > e - 1 ? e - 1 : p + 1,
                    s = 0 > n - 1 ? 0 : n - 1,
                ...
                for (r = 0; r < s; r++) {
                    ...
                    m.push(c([l[1] * B[2] - l[2] * B[1], l[2] * B[0] - l[0] * B[2], l[0] * B[1] - l[1] * B[0]]))
                }
                q = [0, 0, 0];
                for (r = 0; r < m.length; r++) q[0] += m[r][0], q[1] += m[r][1], q[2] += m[r][2];
                q[0] /= m.length;
                q[1] /= m.length;
                q[2] /= m.length;
                u = 4 * (p * d + n);
...
THREE.FontUtils = {
    ...
    extractGlyphPoints: function (a, b, c, d, e) {
        var f = [],
            g, h, i, k, n, p, m, r, s, l, q, u = b.glyphs[a] || b.glyphs["?"];
        if (u) {
            if (u.o) {
                ...
                for (a = 0; a < k;) switch (i = b[a++], i) {
                    ...
                    case "q":
                        ...
                        break;
                    case "b":
                        if (i = b[a++] * c + d, n = b[a++] * c, r = b[a++] * c + d, s = b[a++] * -c, l = b[a++] * c + d, q = b[a++] * -c, e.bezierCurveTo(i, n, r, s, l, q), g = f[f.length - 1]) {
                            p = g.x;
                            m = g.y;
                            g = 1;
                            for (h = this.divisions; g <= h; g++) B = g / h, THREE.Shape.Utils.b3(B, p, r, l, i), THREE.Shape.Utils.b3(B, m, s, q, n)
                        }
                }
            }
            return {
        ...
        for (k = e - 1; 2 < e;) {
            ...
            a: {
                ...
                if (1E-10 > (l - r) * (B - s) - (q - s) * (u - r)) m = !1;
                    ...
                    for (m = 0; m < e; m++)
                        if (!(m === i || m === k || m === n))
                            if (x = a[g[m]].x, t = a[g[m]].y, I = x - r, $ = t - s, D = x - l, L = t - q, x -= u, t -= B, D = F * L - C * D, I = H * $ - G * I, $ = A * t - z * x, 0 <= D && 0 <= $ && 0 <= I) {
                                m = !1;
                                break a
                            } m = !0
                }
...
THREE.CurvePath.prototype.getBoundingBox = function () {
    ...
    var h, i, k, n, p = a[0] instanceof THREE.Vector3;
    n = p ? new THREE.Vector3 : new THREE.Vector2;
    i = 0;
    for (k = a.length; i < k; i++) h = a[i], h.x > b ? b = h.x : h.x < e && (e = h.x), h.y > c ? c = h.y : h.y < f && (f = h.y), p && (h.z > d ? d = h.z : h.z < g && (g = h.z)), n.addSelf(h);
    a = {
        minX: e,
        minY: f,
        maxX: b,
        maxY: c,
        centroid: n.divideScalar(k)
    };
    p && (a.maxZ = d, a.minZ = g);
    return a
};
...
THREE.Path.prototype.getPoints = function (a, b) {
    ...
    for (e = this.actions.length; d < e; d++) switch (f = this.actions[d], g = f.action, f = f.args, g) {
        ...
        case THREE.PathActions.QUADRATIC_CURVE_TO:
            ...
            for (f = 1; f <= a; f++) l = f / a, g = THREE.Shape.Utils.b2(l, r, p, h), l = THREE.Shape.Utils.b2(l, s, m, i), c.push(new THREE.Vector2(g, l));
            break;
        case THREE.PathActions.BEZIER_CURVE_TO:
            ...
            for (f = 1; f <= a; f++) l = f / a, g = THREE.Shape.Utils.b3(l, r, p, k, h), l = THREE.Shape.Utils.b3(l, s, m, n, i), c.push(new THREE.Vector2(g, l));
            break;
        ...
        case THREE.PathActions.ARC:
            ...
            r = g - k;
            s = 2 * a;
            for (f = 1; f <= s; f++) l = f / s, p || (l = 1 - l), l = k + l * r, g = h + m * Math.cos(l), l = i + m * Math.sin(l), c.push(new THREE.Vector2(g, l));
            break;
        case THREE.PathActions.ELLIPSE:
            ...
            r = g - k;
            s = 2 * a;
            for (f = 1; f <= s; f++) l = f / s, p ||
                (l = 1 - l), l = k + l * r, g = h + m * Math.cos(l), l = i + n * Math.sin(l), c.push(new THREE.Vector2(g, l))
    }
    d = c[c.length - 1];
    ...
    removeHoles: function (a, b) {
        ...
        for (i = 0; i < b.length; i++) {
            ...
            for (e = 0; e < k.length; e++) {
                m = k[e];
                r = [];
                for (p = 0; p < c.length; p++) n = c[p], n = m.distanceToSquared(n), r.push(n), n < f && (f = n, g = e, h = p)
            }
            ...
            p + m > l + q && (h = r, g = n, 0 > h && (h += c.length), h %= c.length, 0 > g && (g += k.length), g %= k.length, e = 0 <= h - 1 ? h - 1 : c.length - 1, f = 0 <= g - 1 ? g - 1 : k.length - 1);
            p = c.slice(0, h);
            m = c.slice(h);
            r = k.slice(g);
            n = k.slice(0, g);
                                ...
                                for (k in h) {
                                    for (i = 0; i < a.hierarchy[c].keys[d].morphTargets.length; i++)
                                        if (a.hierarchy[c].keys[d].morphTargets[i] === k) {
                                            ...
                                            break
                                        } i === a.hierarchy[c].keys[d].morphTargets.length && (n[k] = 0)
                                }
                    ...
                    if (k < n)
                        if (this.loop) {
                            ...
                            for (h = this.getNextKeyWith(c, p, 1); h.time <
                                k;) g = h, h = this.getNextKeyWith(c, p, h.index + 1)
                        } else {
                            this.stop();
                            return
                        }
                    else {
                        do g = h, h = this.getNextKeyWith(c, p, h.index + 1); while (h.time < k)
                    }
                    i.prevKey[c] = g;
                    i.nextKey[c] = h
                }
    ...
    if (this.isPlaying) {
        ...
        if ((i = g < h) && !this.loop) {
            for (var a = 0, k = this.hierarchy.length; a < k; a++) {
                ...
                if (n.length) {
                    for (n =
                        0; n < f.length; n++) g = f[n], (h = this.getPrevKeyWith(g, a, d)) && h.apply(g);
                    this.data.hierarchy[a].node.updateMatrix();
                    ...
                    if (b && c) {
                        if (c.time <= h) {
                            if (i && this.loop) {
                                ...
                                for (var m = n.length - 1; c.time < g && c.index !== m;) b = c, c = n[b.index + 1];
                            p.prevKey = b;
                            p.nextKey = c
                        }
...
THREE.CubeGeometry = function (a, b, c, d, e, f) {
    function g(a, b, c, d, e, f, g, l) {
        ...
        else if ("x" === a && "z" === b || "z" === a && "x" === b) q = "y", B = h.depthSegments;
        ...
        for (e =
            0; e < B; e++)
            for (f = 0; f < u; f++) a = new THREE.Face4(f + C * e + F, f + C * (e + 1) + F, f + 1 + C * (e + 1) + F, f + 1 + C * e + F), a.normal.copy(G), a.vertexNormals.push(G.clone(), G.clone(), G.clone(), G.clone()), a.materialIndex = l, h.faces.push(a), h.faceVertexUvs[0].push([new THREE.Vector2(f / u, 1 - e / B), new THREE.Vector2(f / u, 1 - (e + 1) / B), new THREE.Vector2((f + 1) / u, 1 - (e + 1) / B), new THREE.Vector2((f + 1) / u, 1 - e / B)])
    }
    THREE.Geometry.call(this);
    var h = this;
    this.width = a;
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    c = (b - a) / c;
    for (h = 0; h < d; h++) {
        0 !== a ? (p = this.vertices[k[0][h]].clone(),
            m = this.vertices[k[0][h + 1]].clone()) : (p = this.vertices[k[1][h]].clone(), m = this.vertices[k[1][h + 1]].clone());
    ...
    if (!f && 0 <
        ...
        for (h = 0; h < d; h++) r = k[0][h], s = k[0][h + 1], l = this.vertices.length - 1, u = new THREE.Vector3(0, 1, 0), B = new THREE.Vector3(0, 1, 0), x = new THREE.Vector3(0, 1, 0), F = n[0][h].clone(), C = n[0][h + 1].clone(), A = new THREE.Vector2(C.u, 0), this.faces.push(new THREE.Face3(r, s, l, [u, B, x])), this.faceVertexUvs[0].push([F, C, A])
    }
    if (!f && 0 < b) {
        this.vertices.push(new THREE.Vector3(0, -g, 0));
        for (h = 0; h < d; h++) r = k[i][h + 1], s = k[i][h], l = this.vertices.length - 1, u = new THREE.Vector3(0, -1, 0), B = new THREE.Vector3(0,
            -1, 0), x = new THREE.Vector3(0, -1, 0), F = n[i][h + 1].clone(), C = n[i][h].clone(), A = new THREE.Vector2(C.u, 1), this.faces.push(new THREE.Face3(r, s, l, [u, B, x])), this.faceVertexUvs[0].push([F, C, A])
    }
    this.computeCentroids();
    this.computeFaceNormals()
};
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    var h = void 0 !==
        ...
        t, F, C, A;
    s && (l = s.getSpacedPoints(r), q = !0, p = !1, t = void 0 !== b.frames ? b.frames : new THREE.TubeGeometry.FrenetFrames(s,
        r, !1), F = new THREE.Vector3, C = new THREE.Vector3, A = new THREE.Vector3);
    p || (k = i = n = 0);
    var z, H, G, I = this,
    ...
    if (s = !THREE.Shape.Utils.isClockWise(D)) {
        D = D.reverse();
        H = 0;
        for (G = m.length; H < G; H++) z = m[H], THREE.Shape.Utils.isClockWise(z) && (m[H] = z.reverse());
        s = !1
    }
    ...
    var y, J, K, R, P = D.length,
        ca = L.length,
        xa = [],
        M = 0,
        pa = s.length;
    y = pa - 1;
    for (J = M + 1; M < pa; M++, y++, J++) y === pa &&
        (y = 0), J === pa && (J = 0), xa[M] = d(s[M], s[y], s[J]);
    var ya = [],
        ua, N = xa.concat();
    H = 0;
    for (G = m.length; H < G; H++) {
        ...
        pa = z.length;
        y = pa - 1;
        for (J = M + 1; M < pa; M++, y++, J++) y === pa && (y = 0), J === pa && (J = 0), ua[M] = d(z[M], z[y], z[J]);
        ya.push(ua);
        N = N.concat(ua)
    }
    for (y = 0; y < n; y++) {
    ...
    J = k;
    for (M = 0; M < P; M++) R = p ? c(D[M], N[M],
        J) : D[M], q ? (C.copy(t.normals[0]).multiplyScalar(R.x), F.copy(t.binormals[0]).multiplyScalar(R.y), A.copy(l[0]).addSelf(C).addSelf(F), f(A.x, A.y, A.z)) : f(R.x, R.y, 0);
    for (z = 1; z <= r; z++)
        for (M = 0; M < P; M++) R = p ? c(D[M], N[M], J) : D[M], q ? (C.copy(t.normals[z]).multiplyScalar(R.x), F.copy(t.binormals[z]).multiplyScalar(R.y), A.copy(l[z]).addSelf(C).addSelf(F), f(A.x, A.y, A.z)) : f(R.x, R.y, h / r * z);
    for (y = n - 1; 0 <= y; y--) {
        z = y / n;
        K = i * (1 - z);
        J = k * Math.sin(z * Math.PI / 2);
        M = 0;
        for (pa = s.length; M < pa; M++) R = c(s[M], xa[M], J), f(R.x, R.y, h + K);
        H = 0;
        for (G =
            m.length; H < G; H++) {
            z = m[H];
            ua = ya[H];
            M = 0;
            for (pa = z.length; M < pa; M++) R = c(z[M], ua[M], J), q ? f(R.x, R.y + l[r - 1].y, l[r - 1].x + K) : f(R.x, R.y, h + K)
        }
    }
    if (p) {
        i = 0 * P;
        ...
        for (M = 0; M < ca; M++) h = L[M], g(h[0] + P * r, h[1] + P * r, h[2] + P * r, !1)
    }
    h = 0;
    e(s, h);
    h += s.length;
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
    ...
    generateSideWallUV: function (a, b, c, d, e, f, g, h) {
        var b = a.vertices[e].x,
            ...
            m = a.vertices[h].y,
            a = a.vertices[h].z;
        return 0.01 > Math.abs(c - i) ? [new THREE.Vector2(b, 1 - e), new THREE.Vector2(d, 1 - f), new THREE.Vector2(k, 1 - g), new THREE.Vector2(p, 1 - a)] : [new THREE.Vector2(c, 1 - e), new THREE.Vector2(i, 1 - f), new THREE.Vector2(n, 1 - g), new THREE.Vector2(m, 1 - a)]
    }
};
...
THREE.ShapeGeometry.prototype.addShape = function (a, b) {
    ...
    for (e = 0; e < f; e++) k = n[e], i = k[0] + h, g = k[1] + h, k = k[2] + h, this.faces.push(new THREE.Face3(i, g, k, null, null, c)), this.faceVertexUvs[0].push(d.generateBottomUV(this, a, b, i, g, k))
};
THREE.LatheGeometry = function (a, b, c) {
    ...
    for (var g = b + 1, c = 0; c < g; c++)
        for (f = 0; f < d.length; f++) d[f] = e.multiplyVector3(d[f].clone()), this.vertices.push(d[f]);
    for (c = 0; c < b; c++) {
        d = 0;
        for (e = a.length; d < e - 1; d++) this.faces.push(new THREE.Face4(c * e + d, (c + 1) % g * e + d, (c + 1) % g * e + (d + 1) % e, c * e + (d + 1) % e)), this.faceVertexUvs[0].push([new THREE.Vector2(1 - c / b, d / e), new THREE.Vector2(1 -
            (c + 1) / b, d / e), new THREE.Vector2(1 - (c + 1) / b, (d + 1) / e), new THREE.Vector2(1 - c / b, (d + 1) / e)])
    }
    this.computeCentroids();
    this.computeFaceNormals();
...
THREE.PlaneGeometry = function (a, b, c, d) {
    ...
    for (var c = a / 2, e = b / 2, d = this.widthSegments, f = this.heightSegments, g = d + 1, h = f + 1, i = this.width / d, k = this.height / f, n = new THREE.Vector3(0, 0, 1), a = 0; a < h; a++)
        for (b = 0; b < g; b++) this.vertices.push(new THREE.Vector3(b * i - c, -(a * k - e), 0));
    for (a = 0; a < f; a++)
        for (b = 0; b < d; b++) c = new THREE.Face4(b + g * a, b + g * (a + 1), b + 1 + g * (a + 1), b + 1 + g * a), c.normal.copy(n), c.vertexNormals.push(n.clone(), n.clone(),
            n.clone(), n.clone()), this.faces.push(c), this.faceVertexUvs[0].push([new THREE.Vector2(b / d, 1 - a / f), new THREE.Vector2(b / d, 1 - (a + 1) / f), new THREE.Vector2((b + 1) / d, 1 - (a + 1) / f), new THREE.Vector2((b + 1) / d, 1 - a / f)]);
    this.computeCentroids()
};
    ...
    for (c = 0; c < this.heightSegments; c++)
        for (b = 0; b < this.widthSegments; b++) {
            var d = h[c][b + 1],
                ...
                l = i[c + 1][b].clone(),
                q = i[c + 1][b + 1].clone();
            Math.abs(this.vertices[d].y) === this.radius ? (this.faces.push(new THREE.Face3(d, f, g, [k, p, m])), this.faceVertexUvs[0].push([r, l, q])) : Math.abs(this.vertices[f].y) === this.radius ? (this.faces.push(new THREE.Face3(d, e, f, [k, n, p])), this.faceVertexUvs[0].push([r, s, l])) : (this.faces.push(new THREE.Face4(d, e, f, g, [k, n, p, m])), this.faceVertexUvs[0].push([r, s, l, q]))
        }
    this.computeCentroids();
    this.computeFaceNormals();
    this.boundingSphere = new THREE.Sphere(new THREE.Vector3, a)
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
    ...
    var g, h, e = this.segments + 1,
        i, k, n, f = new THREE.Vector3,
        p, m, r, b = new THREE.TubeGeometry.FrenetFrames(this.path, this.segments, this.closed);
    p = b.tangents;
    m = b.normals;
    r = b.binormals;
    this.tangents = p;
    ...
    for (b = 0; b < e; b++) {
        ...
        g = m[b];
        h = r[b];
        this.debug && (this.debug.add(new THREE.ArrowHelper(d, n, c, 255)), this.debug.add(new THREE.ArrowHelper(g, n, c, 16711680)), this.debug.add(new THREE.ArrowHelper(h, n, c, 65280)));
        for (d = 0; d < this.radiusSegments; d++) i = 2 * (d / this.radiusSegments) * Math.PI, k = -this.radius * Math.cos(i), i = this.radius * Math.sin(i), f.copy(n), f.x += k * g.x + i * h.x, f.y += k * g.y + i * h.y, f.z += k * g.z + i * h.z, this.grid[b][d] = this.vertices.push(new THREE.Vector3(f.x, f.y, f.z)) - 1
    }
    for (b = 0; b < this.segments; b++)
        for (d = 0; d < this.radiusSegments; d++) e = this.closed ?
            (b + 1) % this.segments : b + 1, f = (d + 1) % this.radiusSegments, a = this.grid[b][d], c = this.grid[e][d], e = this.grid[e][f], f = this.grid[b][f], p = new THREE.Vector2(b / this.segments, d / this.radiusSegments), m = new THREE.Vector2((b + 1) / this.segments, d / this.radiusSegments), r = new THREE.Vector2((b + 1) / this.segments, (d + 1) / this.radiusSegments), g = new THREE.Vector2(b / this.segments, (d + 1) / this.radiusSegments), this.faces.push(new THREE.Face4(a, c, e, f)), this.faceVertexUvs[0].push([p, m, r, g]);
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
};
...
THREE.TubeGeometry.FrenetFrames = function (a, b, c) {
    ...
    this.normals = f;
    this.binormals = g;
    for (k = 0; k < b; k++) n = k / (b - 1), e[k] = a.getTangentAt(n), e[k].normalize();
    ...
    f[0].cross(e[0], h);
    g[0].cross(e[0], f[0]);
    for (k = 1; k < b; k++) f[k] = f[k - 1].clone(), g[k] = g[k - 1].clone(), h.cross(e[k - 1], e[k]), 1E-4 < h.length() && (h.normalize(), d = Math.acos(e[k - 1].dot(e[k])), i.makeRotationAxis(h, d).multiplyVector3(f[k])), g[k].cross(e[k], f[k]);
    if (c) {
        d = Math.acos(f[0].dot(f[b - 1]));
        d /= b - 1;
        0 < e[0].dot(h.cross(f[0], f[b - 1])) && (d = -d);
        for (k = 1; k < b; k++) i.makeRotationAxis(e[k], d * k).multiplyVector3(f[k]), g[k].cross(e[k], f[k])
    }
};
THREE.PolyhedronGeometry = function (a, b, c, d) {
    ...
    function g(a, b) {
        ...
        void 0 === c && (p[a.index][b.index] = p[b.index][a.index] = c = e((new THREE.Vector3).add(a, b).divideScalar(2)));
        return c
    }
    ...
    THREE.Geometry.call(this);
    for (var c = c || 1, d = d || 0, i = this, k = 0, n = a.length; k < n; k++) e(new THREE.Vector3(a[k][0], a[k][1], a[k][2]));
    for (var p = [], a = this.vertices, k = 0, n = b.length; k < n; k++) f(a[b[k][0]], a[b[k][1]], a[b[k][2]], d);
    this.mergeVertices();
    k = 0;
...
THREE.ParametricGeometry = function (a, b, c, d) {
    ...
    var m, r, s, l;
    for (h = 0; h < c; h++)
        for (i = 0; i < b; i++) a = h * p + i, e = h * p + i + 1, n = (h + 1) * p + i, k = (h + 1) * p + i + 1, m = new THREE.Vector2(i / b, h / c), r = new THREE.Vector2((i + 1) / b, h / c), s = new THREE.Vector2(i / b, (h + 1) / c), l = new THREE.Vector2((i + 1) / b, (h + 1) / c), d ? (f.push(new THREE.Face3(a, e, n)), f.push(new THREE.Face3(e,
            k, n)), g.push([m, r, s]), g.push([r, l, s])) : (f.push(new THREE.Face4(a, e, k, n)), g.push([m, r, l, s]));
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
};
...
THREE.HemisphereLightHelper = function (a, b, c) {
    ...
    for (var d = this.groundColor.getHex(), f = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0, 0.5 * Math.PI), g = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0.5 *
            ...
            color: d,
            fog: !1
        }), k = 0, n = f.faces.length; k < n; k++) f.faces[k].materialIndex = 0;
    k = 0;
...
THREE.LensFlarePlugin = function () {
    ...
    this.init = function (r) {
        ...
        b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, b.NEAREST);
        b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, b.NEAREST);
        0 >= b.getParameter(b.MAX_VERTEX_TEXTURE_IMAGE_UNITS) ? (k = !1, n = a(THREE.ShaderFlares.lensFlare)) : (k = !0, n = a(THREE.ShaderFlares.lensFlareVertexTexture));
        p = {};
        m = {};
        ...
        m.color = b.getUniformLocation(n,
            "color");
    ...
    this.render = function (a, d, e, q) {
        ...
        if (u) {
            ...
            var I, $, D, L, y;
            for (I = 0; I < u; I++)
                if (C = 16 / q, A.set(C * x, C), L = a[I], B.set(L.matrixWorld.elements[12], L.matrixWorld.elements[13], L.matrixWorld.elements[14]), d.matrixWorldInverse.multiplyVector3(B), d.projectionMatrix.multiplyVector3(B), z.copy(B), H.x = z.x * t + t, H.y = z.y * F + F, k || 0 < H.x && H.x < e && 0 < H.y && H.y < q) {
                    ...
                    b.enable(b.BLEND);
                    $ = 0;
                    for (D = L.lensFlares.length; $ < D; $++) y = L.lensFlares[$], 0.001 < y.opacity && 0.001 < y.scale && (z.x = y.x, z.y = y.y, z.z = y.z, C = y.size * y.scale / q, A.x = C * x, A.y = C, b.uniform3f(G.screenPosition, z.x, z.y, z.z), b.uniform2f(G.scale, A.x, A.y), b.uniform1f(G.rotation, y.rotation), b.uniform1f(G.opacity, y.opacity), b.uniform3f(G.color, y.color.r, y.color.g, y.color.b), c.setBlending(y.blending,
                        y.blendEquation, y.blendSrc, y.blendDst), c.setTexture(y.texture, 1), b.drawElements(b.TRIANGLES, 6, b.UNSIGNED_SHORT, 0))
...
THREE.ShadowMapPlugin = function () {
    ...
    this.update = function (n, p) {
                ...
                if (s instanceof THREE.DirectionalLight && s.shadowCascade)
                    for (q = 0; q < s.shadowCascadeCount; q++) {
                        ...
                        if (s.shadowCascadeArray[q]) C = s.shadowCascadeArray[q];
                            ...
                            x = C.pointsWorld;
                            u = C.pointsFrustum;
                            for (var A = 0; 8 > A; A++) x[A] = new THREE.Vector3, u[A] = new THREE.Vector3;
        ...
        for (r = F.length; m < r; m++) {
            s = F[m];
            s.shadowMap || (q = THREE.LinearFilter, b.shadowMapType === THREE.PCFSoftShadowMap && (q = THREE.NearestFilter), s.shadowMap = new THREE.WebGLRenderTarget(s.shadowMapWidth, s.shadowMapHeight, {
                minFilter: q,
                magFilter: q,
            ...
            s.shadowCameraVisible &&
                !s.cameraHelper && (s.cameraHelper = new THREE.CameraHelper(s.shadowCamera), s.shadowCamera.add(s.cameraHelper));
            if (s.isVirtual && C.originalCamera == p) {
                ...
                for (B = 0; 8 > B; B++) x = t[B], x.copy(u[B]), THREE.ShadowMapPlugin.__projector.unprojectVector(x, q), l.matrixWorldInverse.multiplyVector3(x), x.x < i.x && (i.x = x.x), x.x > k.x && (k.x = x.x), x.y < i.y && (i.y = x.y), x.y > k.y && (k.y = x.y), x.z < i.z && (i.z = x.z), x.z >
                    k.z && (k.z = x.z);
                l.left = i.x;
                l.right = k.x;
                l.top = k.y;
            ...
            for (l = t.length; s < l; s++)
                if (B = t[s], u = B.object, B.render = !1, u.visible && u.castShadow && (!(u instanceof THREE.Mesh || u instanceof THREE.ParticleSystem) || !u.frustumCulled || g.contains(u))) u._modelViewMatrix.multiply(q.matrixWorldInverse, u.matrixWorld), B.render = !0;
            s = 0;
            for (l = t.length; s < l; s++) B = t[s], B.render && (u = B.object, B = B.buffer, A = u.material instanceof THREE.MeshFaceMaterial ? u.material.materials[0] :
                u.material, x = 0 < u.geometry.morphTargets.length && A.morphTargets, A = u instanceof THREE.SkinnedMesh && A.skinning, x = u.customDepthMaterial ? u.customDepthMaterial : A ? x ? f : e : x ? d : c, B instanceof THREE.BufferGeometry ? b.renderBufferDirect(q, n.__lights, null, x, B, u) : b.renderBuffer(q, n.__lights, null, x, B, u));
            t = n.__webglObjectsImmediate;
            s = 0;
            for (l = t.length; s < l; s++) B = t[s], u = B.object, u.visible && u.castShadow && (u._modelViewMatrix.multiply(q.matrixWorldInverse, u.matrixWorld), b.renderImmediateObject(q, n.__lights, null, c, u))
        }
        m =
            b.getClearColor();
        r = b.getClearAlpha();
...
THREE.SpritePlugin = function () {
    ...
    this.init = function (a) {
        ...
        k.uvOffset = b.getUniformLocation(h,
            "uvOffset");
        ...
        k.modelViewMatrix =
            b.getUniformLocation(h, "modelViewMatrix");
    ...
    this.render = function (d, e, m, r) {
        ...
        if (l) {
            ...
            var t = q = 0,
                F = d.fog;
            F ? (b.uniform3f(u.fogColor, F.color.r, F.color.g, F.color.b), F instanceof THREE.Fog ? (b.uniform1f(u.fogNear, F.near), b.uniform1f(u.fogFar,
                F.far), b.uniform1i(u.fogType, 1), t = q = 1) : F instanceof THREE.FogExp2 && (b.uniform1f(u.fogDensity, F.density), b.uniform1i(u.fogType, 2), t = q = 2)) : (b.uniform1i(u.fogType, 0), t = q = 0);
            for (var C, A, z = [], F = 0; F < l; F++) C = s[F], A = C.material, C.visible && 0 !== A.opacity && (A.useScreenCoordinates ? C.z = -C.position.z : (C._modelViewMatrix.multiply(e.matrixWorldInverse, C.matrixWorld), C.z = -C._modelViewMatrix.elements[14]));
            s.sort(a);
            for (F = 0; F < l; F++) C = s[F], A = C.material, C.visible && 0 !== A.opacity && (A.map && A.map.image && A.map.image.width) &&
...
THREE.DepthPassPlugin = function () {
    ...
    this.update = function (i, k) {
        ...
        for (p = l.length; n < p; n++)
            if (m = l[n], s = m.object, m.render = !1, s.visible && (!(s instanceof THREE.Mesh || s instanceof THREE.ParticleSystem) || !s.frustumCulled || g.contains(s))) s._modelViewMatrix.multiply(k.matrixWorldInverse, s.matrixWorld), m.render = !0;
        var q;
        n = 0;
        for (p = l.length; n < p; n++)
            if (m = l[n], m.render && (s = m.object, m = m.buffer, !(s instanceof THREE.ParticleSystem) || s.customDepthMaterial))(q = s.material instanceof THREE.MeshFaceMaterial ? s.material.materials[0] : s.material) && b.setMaterialFaces(s.material), r = 0 < s.geometry.morphTargets.length && q.morphTargets, q = s instanceof THREE.SkinnedMesh && q.skinning, r = s.customDepthMaterial ? s.customDepthMaterial : q ? r ? f : e : r ? d : c, m instanceof THREE.BufferGeometry ? b.renderBufferDirect(k, i.__lights, null, r, m, s) : b.renderBuffer(k, i.__lights, null, r, m, s);
        l = i.__webglObjectsImmediate;
        n = 0;
        for (p = l.length; n < p; n++) m = l[n], s = m.object, s.visible && (s._modelViewMatrix.multiply(k.matrixWorldInverse,
